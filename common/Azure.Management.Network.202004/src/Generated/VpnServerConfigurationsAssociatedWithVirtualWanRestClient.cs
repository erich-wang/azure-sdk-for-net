...
namespace Azure.Management.Network202004
{
    internal partial class VpnServerConfigurationsAssociatedWithVirtualWanRestClient
    {
        ...
        public VpnServerConfigurationsAssociatedWithVirtualWanRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
