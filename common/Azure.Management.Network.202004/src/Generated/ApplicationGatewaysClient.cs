...
namespace Azure.Management.Network202004
{
    ...
    public partial class ApplicationGatewaysClient
    {
        ...
        internal ApplicationGatewaysClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ApplicationGatewaysRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        public virtual async Task<ApplicationGatewaysBackendHealthOnDemandOperation> StartBackendHealthOnDemandAsync(string resourceGroupName, string applicationGatewayName, ApplicationGatewayOnDemandProbe probeRequest, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewaysClient.StartBackendHealthOnDemand");
            scope.Start();
            try
            {
