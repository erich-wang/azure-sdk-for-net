...
namespace Azure.Management.Network202004
{
    ...
    public partial class LoadBalancerProbesClient
    {
        ...
        internal LoadBalancerProbesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new LoadBalancerProbesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
