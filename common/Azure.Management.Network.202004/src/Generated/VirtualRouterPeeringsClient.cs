...
namespace Azure.Management.Network202004
{
    ...
    public partial class VirtualRouterPeeringsClient
    {
        ...
        internal VirtualRouterPeeringsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new VirtualRouterPeeringsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
