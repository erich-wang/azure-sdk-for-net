...
namespace Azure.Management.Network202004.Models
{
    public partial class NetworkProfile : IUtf8JsonSerializable
    {
        ...
        internal static NetworkProfile DeserializeNetworkProfile(JsonElement element)
        {
            ...
            IList<ContainerNetworkInterface> containerNetworkInterfaces = default;
            ...
            return new NetworkProfile(id, name, type, location, tags, etag, containerNetworkInterfaces, containerNetworkInterfaceConfigurations, resourceGuid, provisioningState);
        }
    }
}
