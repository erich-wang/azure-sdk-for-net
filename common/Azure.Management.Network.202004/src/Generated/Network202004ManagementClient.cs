...
using Azure.Management.Network202004;

namespace Azure.Management.Network202004
{
    /// <summary> Network202004 service management client. </summary>
    public class Network202004ManagementClient
    {
        ...
        /// <summary> Initializes a new instance of Network202004ManagementClient for mocking. </summary>
        protected Network202004ManagementClient()
        {
        }

        /// <summary> Initializes a new instance of Network202004ManagementClient. </summary>
        ...
        public Network202004ManagementClient(string subscriptionId, TokenCredential tokenCredential, Network202004ManagementClientOptions options = null) : this(subscriptionId, null, tokenCredential, options)
        {
        }
        /// <summary> Initializes a new instance of Network202004ManagementClient. </summary>
        /// <param name="subscriptionId"> The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. </param>
        ...
        public Network202004ManagementClient(string subscriptionId, Uri endpoint, TokenCredential tokenCredential, Network202004ManagementClientOptions options = null)
        {
            ...
            options ??= new Network202004ManagementClientOptions();
