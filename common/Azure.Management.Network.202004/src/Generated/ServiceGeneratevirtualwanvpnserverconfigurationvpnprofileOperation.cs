...
namespace Azure.Management.Network202004
{
    ...
    public partial class ServiceGeneratevirtualwanvpnserverconfigurationvpnprofileOperation : Operation<VpnProfileResponse>, IOperationSource<VpnProfileResponse>
    {
        private readonly ArmOperationHelpers<VpnProfileResponse> _operation;
        internal ServiceGeneratevirtualwanvpnserverconfigurationvpnprofileOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<VpnProfileResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServiceGeneratevirtualwanvpnserverconfigurationvpnprofileOperation");
        }
        /// <inheritdoc />
