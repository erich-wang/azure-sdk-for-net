...
namespace Azure.Management.Network202004
{
    ...
    public partial class NetworkWatchersVerifyIPFlowOperation : Operation<VerificationIPFlowResult>, IOperationSource<VerificationIPFlowResult>
    {
        ...
        /// <inheritdoc />
        public override VerificationIPFlowResult Value => _operation.Value;
        ...
        /// <inheritdoc />
        public override ValueTask<Response<VerificationIPFlowResult>> WaitForCompletionAsync(CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(cancellationToken);

        /// <inheritdoc />
        public override ValueTask<Response<VerificationIPFlowResult>> WaitForCompletionAsync(TimeSpan pollingInterval, CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(pollingInterval, cancellationToken);
