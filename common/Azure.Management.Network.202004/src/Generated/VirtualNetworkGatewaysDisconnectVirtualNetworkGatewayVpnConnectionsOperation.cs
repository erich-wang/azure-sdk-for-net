...
namespace Azure.Management.Network202004
{
    ...
    public partial class VirtualNetworkGatewaysDisconnectVirtualNetworkGatewayVpnConnectionsOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal VirtualNetworkGatewaysDisconnectVirtualNetworkGatewayVpnConnectionsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewaysDisconnectVirtualNetworkGatewayVpnConnectionsOperation");
        }
        /// <inheritdoc />
