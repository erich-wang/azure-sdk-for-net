...
namespace Azure.Management.Network202004
{
    ...
    public partial class HubRouteTablesClient
    {
        ...
        internal HubRouteTablesRestClient RestClient { get; }
        /// <summary> Initializes a new instance of HubRouteTablesClient for mocking. </summary>
        protected HubRouteTablesClient()
        {
        }
        /// <summary> Initializes a new instance of HubRouteTablesClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. </param>
        /// <param name="endpoint"> server parameter. </param>
        internal HubRouteTablesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new HubRouteTablesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("HubRouteTablesClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<HubRouteTable> ListAsync(string resourceGroupName, string virtualHubName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("HubRouteTablesClient.List");
                scope.Start();
                try
                {
        ...
        public virtual async Task<HubRouteTablesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string virtualHubName, string routeTableName, HubRouteTable routeTableParameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HubRouteTablesClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<HubRouteTablesDeleteOperation> StartDeleteAsync(string resourceGroupName, string virtualHubName, string routeTableName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HubRouteTablesClient.StartDelete");
            scope.Start();
            try
            {
