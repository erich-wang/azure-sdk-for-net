...
namespace Azure.Management.Network202004
{
    internal partial class LoadBalancerFrontendIPConfigurationsRestClient
    {
        ...
        public LoadBalancerFrontendIPConfigurationsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
