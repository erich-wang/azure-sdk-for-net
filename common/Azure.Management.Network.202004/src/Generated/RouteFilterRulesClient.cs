...
namespace Azure.Management.Network202004
{
    ...
    public partial class RouteFilterRulesClient
    {
        ...
        internal RouteFilterRulesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new RouteFilterRulesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
