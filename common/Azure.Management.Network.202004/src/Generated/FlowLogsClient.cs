...
namespace Azure.Management.Network202004
{
    ...
    public partial class FlowLogsClient
    {
        ...
        internal FlowLogsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new FlowLogsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
