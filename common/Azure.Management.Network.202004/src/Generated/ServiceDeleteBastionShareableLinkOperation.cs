...
namespace Azure.Management.Network202004
{
    ...
    public partial class ServiceDeleteBastionShareableLinkOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal ServiceDeleteBastionShareableLinkOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServiceDeleteBastionShareableLinkOperation");
        }
        /// <inheritdoc />
