...
namespace Azure.Management.Network202004
{
    ...
    public partial class SubnetsUnprepareNetworkPoliciesOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SubnetsUnprepareNetworkPoliciesOperation");
        }
        /// <inheritdoc />
