...
namespace Azure.Management.Network202004
{
    ...
    public partial class VpnServerConfigurationsClient
    {
        ...
        internal VpnServerConfigurationsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new VpnServerConfigurationsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        public virtual async Task<VpnServerConfigurationsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string vpnServerConfigurationName, VpnServerConfiguration vpnServerConfigurationParameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VpnServerConfigurationsClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<VpnServerConfigurationsDeleteOperation> StartDeleteAsync(string resourceGroupName, string vpnServerConfigurationName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VpnServerConfigurationsClient.StartDelete");
            scope.Start();
            try
            {
