...
namespace Azure.Management.Network202004
{
    ...
    public partial class PrivateLinkServicesClient
    {
        ...
        internal PrivateLinkServicesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new PrivateLinkServicesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        public virtual async Task<PrivateLinkServicesDeleteOperation> StartDeleteAsync(string resourceGroupName, string serviceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServicesClient.StartDelete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<PrivateLinkServicesDeletePrivateEndpointConnectionOperation> StartDeletePrivateEndpointConnectionAsync(string resourceGroupName, string serviceName, string peConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServicesClient.StartDeletePrivateEndpointConnection");
            scope.Start();
            try
            {
