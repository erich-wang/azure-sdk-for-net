...
namespace Azure.Management.Network202004
{
    ...
    public partial class AzureFirewallsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AzureFirewallsDeleteOperation");
        }
        /// <inheritdoc />
