...
namespace Azure.Management.Network202004
{
    ...
    public partial class ConnectionMonitorsClient
    {
        ...
        internal ConnectionMonitorsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ConnectionMonitorsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
