...
namespace Azure.Management.Network202004
{
    ...
    public partial class AzureFirewallsClient
    {
        ...
        internal AzureFirewallsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new AzureFirewallsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
