...
namespace Azure.Management.Network202004
{
    ...
    public partial class NetworkWatchersClient
    {
        ...
        internal NetworkWatchersClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new NetworkWatchersRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
