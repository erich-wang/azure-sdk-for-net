...
namespace Azure.Management.Network202004
{
    ...
    public partial class LoadBalancerLoadBalancingRulesClient
    {
        ...
        internal LoadBalancerLoadBalancingRulesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new LoadBalancerLoadBalancingRulesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
