...
namespace Azure.Management.Network202004
{
    internal partial class VirtualRoutersRestClient
    {
        ...
        public VirtualRoutersRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<VirtualRouterListResult>> ListAsync(CancellationToken cancellationToken = default)
        {
