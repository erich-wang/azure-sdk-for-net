...
namespace Azure.Management.Network202004
{
    ...
    public partial class BgpServiceCommunitiesClient
    {
        ...
        internal BgpServiceCommunitiesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new BgpServiceCommunitiesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
