...
namespace Azure.Management.Network202004
{
    ...
    public partial class ExpressRouteGatewaysClient
    {
        ...
        internal ExpressRouteGatewaysClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ExpressRouteGatewaysRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        public virtual async Task<ExpressRouteGatewaysCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string expressRouteGatewayName, ExpressRouteGateway putExpressRouteGatewayParameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteGatewaysClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ExpressRouteGatewaysDeleteOperation> StartDeleteAsync(string resourceGroupName, string expressRouteGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteGatewaysClient.StartDelete");
            scope.Start();
            try
            {
