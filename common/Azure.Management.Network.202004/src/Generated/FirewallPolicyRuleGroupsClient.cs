...
namespace Azure.Management.Network202004
{
    ...
    public partial class FirewallPolicyRuleGroupsClient
    {
        ...
        internal FirewallPolicyRuleGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new FirewallPolicyRuleGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
