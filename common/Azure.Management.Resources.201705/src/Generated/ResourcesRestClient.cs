...
using Azure.Management.Resources201705.Models;
...
namespace Azure.Management.Resources201705
{
    internal partial class ResourcesRestClient
    {
        ...
        public ResourcesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2017-05-10")
        {
        ...
        internal Azure.Core.HttpMessage CreateListByResourceGroupRequest(string resourceGroupName, string filter, string expand, int? top)
        {
        ...
        internal Azure.Core.HttpMessage CreateMoveResourcesRequest(string sourceResourceGroupName, ResourcesMoveInfo parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateValidateMoveResourcesRequest(string sourceResourceGroupName, ResourcesMoveInfo parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        internal Azure.Core.HttpMessage CreateListRequest(string filter, string expand, int? top)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateCheckExistenceRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateDeleteRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, GenericResource parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateUpdateRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, GenericResource parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Azure.Core.HttpMessage CreateGetRequest(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateCheckExistenceByIdRequest(string resourceId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Head;
        ...
        internal Azure.Core.HttpMessage CreateDeleteByIdRequest(string resourceId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        internal Azure.Core.HttpMessage CreateCreateOrUpdateByIdRequest(string resourceId, GenericResource parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        internal Azure.Core.HttpMessage CreateUpdateByIdRequest(string resourceId, GenericResource parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Patch;
        ...
        internal Azure.Core.HttpMessage CreateGetByIdRequest(string resourceId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateListByResourceGroupNextPageRequest(string nextLink, string resourceGroupName, string filter, string expand, int? top)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateListNextPageRequest(string nextLink, string filter, string expand, int? top)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
