...
namespace Azure.Management.Resources201705
{
    internal partial class DeploymentRestClient
    {
        ...
        public DeploymentRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2017-05-10")
        {
