...
namespace Azure.Management.Storage201906
{
    ...
    public partial class TableServicesClient
    {
        ...
        internal TableServicesRestClient RestClient { get; }
        /// <summary> Initializes a new instance of TableServicesClient for mocking. </summary>
        protected TableServicesClient()
        {
        }
        /// <summary> Initializes a new instance of TableServicesClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        internal TableServicesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2019-06-01")
        {
            RestClient = new TableServicesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TableServicesClient.List");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TableServicesClient.GetServiceProperties");
            scope.Start();
            try
            {
