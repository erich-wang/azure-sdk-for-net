...
namespace Azure.Management.Storage201906
{
    ...
    public partial class TableClient
    {
        ...
        /// <summary> Initializes a new instance of TableClient for mocking. </summary>
        ...
        internal TableClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2019-06-01")
        {
            RestClient = new TableRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TableClient.Update");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TableClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Table> ListAsync(string resourceGroupName, string accountName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TableClient.List");
                scope.Start();
                try
                {
