...
using Azure.Management.Storage201906;

namespace Azure.Management.Storage201906
{
    /// <summary> Storage201906 service management client. </summary>
    public class Storage201906ManagementClient
    {
        ...
        /// <summary> Initializes a new instance of Storage201906ManagementClient for mocking. </summary>
        protected Storage201906ManagementClient()
        {
        }

        /// <summary> Initializes a new instance of Storage201906ManagementClient. </summary>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="tokenCredential"> The OAuth token for making client requests. </param>
        /// <param name="options"> The options for configuring the client. </param>
        public Storage201906ManagementClient(string subscriptionId, TokenCredential tokenCredential, Storage201906ManagementClientOptions options = null) : this(null, subscriptionId, tokenCredential, options)
        {
        }
        /// <summary> Initializes a new instance of Storage201906ManagementClient. </summary>
        ...
        public Storage201906ManagementClient(Uri endpoint, string subscriptionId, TokenCredential tokenCredential, Storage201906ManagementClientOptions options = null)
        {
            ...
            options ??= new Storage201906ManagementClientOptions();
