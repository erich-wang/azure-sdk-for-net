...
namespace Azure.Management.Compute201904
{
    ...
    public partial class AvailabilitySetsClient
    {
        ...
        internal AvailabilitySetsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new AvailabilitySetsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AvailabilitySetsClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AvailabilitySetsClient.Update");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AvailabilitySetsClient.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AvailabilitySetsClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<AvailabilitySet> ListBySubscriptionAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AvailabilitySetsClient.ListBySubscription");
                scope.Start();
                try
                {
