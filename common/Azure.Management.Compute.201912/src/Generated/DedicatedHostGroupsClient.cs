...
namespace Azure.Management.Compute201904
{
    ...
    public partial class DedicatedHostGroupsClient
    {
        ...
        internal DedicatedHostGroupsRestClient RestClient { get; }
        /// <summary> Initializes a new instance of DedicatedHostGroupsClient for mocking. </summary>
        protected DedicatedHostGroupsClient()
        {
        }
        /// <summary> Initializes a new instance of DedicatedHostGroupsClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. </param>
        /// <param name="endpoint"> server parameter. </param>
        internal DedicatedHostGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new DedicatedHostGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupsClient.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupsClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<DedicatedHostGroup> ListByResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupsClient.ListByResourceGroup");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<DedicatedHostGroup> ListBySubscriptionAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<DedicatedHostGroup>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroupsClient.ListBySubscription");
                scope.Start();
                try
                {
