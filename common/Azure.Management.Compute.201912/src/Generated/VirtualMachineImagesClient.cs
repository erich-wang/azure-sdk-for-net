...
namespace Azure.Management.Compute201904
{
    ...
    public partial class VirtualMachineImagesClient
    {
        ...
        internal VirtualMachineImagesRestClient RestClient { get; }
        /// <summary> Initializes a new instance of VirtualMachineImagesClient for mocking. </summary>
        ...
        internal VirtualMachineImagesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new VirtualMachineImagesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineImagesClient.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineImagesClient.List");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineImagesClient.ListOffers");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineImagesClient.ListPublishers");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineImagesClient.ListSkus");
            scope.Start();
            try
            {
