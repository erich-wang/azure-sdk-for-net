...
using Azure.Management.Compute201904;

namespace Azure.Management.Compute201904
{
    /// <summary> Compute201904 service management client. </summary>
    public class Compute201904ManagementClient
    {
        ...
        /// <summary> Initializes a new instance of Compute201904ManagementClient for mocking. </summary>
        protected Compute201904ManagementClient()
        {
        }

        /// <summary> Initializes a new instance of Compute201904ManagementClient. </summary>
        ...
        public Compute201904ManagementClient(string subscriptionId, TokenCredential tokenCredential, Compute201904ManagementClientOptions options = null) : this(null, subscriptionId, tokenCredential, options)
        {
        }
        /// <summary> Initializes a new instance of Compute201904ManagementClient. </summary>
        ...
        public Compute201904ManagementClient(Uri endpoint, string subscriptionId, TokenCredential tokenCredential, Compute201904ManagementClientOptions options = null)
        {
            ...
            options ??= new Compute201904ManagementClientOptions();
