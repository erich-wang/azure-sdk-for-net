...
namespace Azure.Management.Compute201904.Models
{
    public partial class VirtualMachineScaleSetExtensionUpdate : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetExtensionUpdate DeserializeVirtualMachineScaleSetExtensionUpdate(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetExtensionUpdate(id, name, type, forceUpdateTag, publisher, type0, typeHandlerVersion, autoUpgradeMinorVersion, settings, protectedSettings, provisioningState, provisionAfterExtensions);
        }
    }
}
