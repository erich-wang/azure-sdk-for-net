...
namespace Azure.Management.Compute201904.Models
{
    public partial class VirtualMachineIdentity : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineIdentity DeserializeVirtualMachineIdentity(JsonElement element)
        {
            ...
            IDictionary<string, Components1H8M3EpSchemasVirtualmachineidentityPropertiesUserassignedidentitiesAdditionalproperties> userAssignedIdentities = default;
            ...
            return new VirtualMachineIdentity(principalId, tenantId, type, userAssignedIdentities);
        }
    }
}
