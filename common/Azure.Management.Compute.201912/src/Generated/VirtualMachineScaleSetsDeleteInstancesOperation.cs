...
namespace Azure.Management.Compute201904
{
    ...
    public partial class VirtualMachineScaleSetsDeleteInstancesOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetsDeleteInstancesOperation");
        }
        /// <inheritdoc />
