...
namespace Azure.Management.Compute201904
{
    ...
    public partial class VirtualMachineRunCommandsClient
    {
        ...
        internal VirtualMachineRunCommandsRestClient RestClient { get; }
        /// <summary> Initializes a new instance of VirtualMachineRunCommandsClient for mocking. </summary>
        protected VirtualMachineRunCommandsClient()
        {
        }
        /// <summary> Initializes a new instance of VirtualMachineRunCommandsClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. </param>
        /// <param name="endpoint"> server parameter. </param>
        internal VirtualMachineRunCommandsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new VirtualMachineRunCommandsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandsClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<RunCommandDocumentBase> ListAsync(string location, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualMachineRunCommandsClient.List");
                scope.Start();
                try
                {
