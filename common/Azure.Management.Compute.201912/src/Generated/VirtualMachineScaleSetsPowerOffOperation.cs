...
namespace Azure.Management.Compute201904
{
    ...
    public partial class VirtualMachineScaleSetsPowerOffOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal VirtualMachineScaleSetsPowerOffOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetsPowerOffOperation");
        }
        /// <inheritdoc />
