...
using Azure.Management.Compute201904.Models;
...
namespace Azure.Management.Compute201904
{
    ...
    public partial class VirtualMachineScaleSetsClient
    {
        ...
        internal VirtualMachineScaleSetsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new VirtualMachineScaleSetsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
