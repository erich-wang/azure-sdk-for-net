...
namespace Azure.Management.Compute201904
{
    ...
    public partial class VirtualMachinesCaptureOperation : Operation<VirtualMachineCaptureResult>, IOperationSource<VirtualMachineCaptureResult>
    {
        ...
        /// <inheritdoc />
        public override VirtualMachineCaptureResult Value => _operation.Value;
        ...
        /// <inheritdoc />
        public override ValueTask<Response<VirtualMachineCaptureResult>> WaitForCompletionAsync(CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(cancellationToken);

        /// <inheritdoc />
        public override ValueTask<Response<VirtualMachineCaptureResult>> WaitForCompletionAsync(TimeSpan pollingInterval, CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(pollingInterval, cancellationToken);
