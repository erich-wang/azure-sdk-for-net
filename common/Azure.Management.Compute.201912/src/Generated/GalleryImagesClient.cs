...
namespace Azure.Management.Compute201904
{
    ...
    public partial class GalleryImagesClient
    {
        ...
        internal GalleryImagesRestClient RestClient { get; }
        /// <summary> Initializes a new instance of GalleryImagesClient for mocking. </summary>
        ...
        internal GalleryImagesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new GalleryImagesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("GalleryImagesClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<GalleryImage> ListByGalleryAsync(string resourceGroupName, string galleryName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("GalleryImagesClient.ListByGallery");
                scope.Start();
                try
                {
        ...
        public virtual async Task<GalleryImagesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string galleryName, string galleryImageName, GalleryImage galleryImage, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("GalleryImagesClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<GalleryImagesUpdateOperation> StartUpdateAsync(string resourceGroupName, string galleryName, string galleryImageName, GalleryImageUpdate galleryImage, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("GalleryImagesClient.StartUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<GalleryImagesDeleteOperation> StartDeleteAsync(string resourceGroupName, string galleryName, string galleryImageName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("GalleryImagesClient.StartDelete");
            scope.Start();
            try
            {
