...
namespace Azure.Management.Compute201904
{
    ...
    public partial class VirtualMachineScaleSetVMExtensionsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal VirtualMachineScaleSetVMExtensionsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetVMExtensionsDeleteOperation");
        }
        /// <inheritdoc />
