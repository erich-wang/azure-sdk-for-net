...
namespace Azure.Management.Compute201904
{
    ...
    public partial class ProximityPlacementGroupsClient
    {
        ...
        internal ProximityPlacementGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null)
        {
            RestClient = new ProximityPlacementGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint);
