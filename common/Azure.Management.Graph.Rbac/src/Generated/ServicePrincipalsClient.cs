...
namespace Azure.Management.Graph.Rbac
{
    ...
    public partial class ServicePrincipalsClient
    {
        ...
        internal ServicePrincipalsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            RestClient = new ServicePrincipalsRestClient(clientDiagnostics, pipeline, tenantID, endpoint, apiVersion);
