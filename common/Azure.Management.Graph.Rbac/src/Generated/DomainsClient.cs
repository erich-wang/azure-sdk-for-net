...
using Azure.Management.Graph.Rbac.Models;

namespace Azure.Management.Graph.Rbac
{
    ...
    public partial class DomainsClient
    {
        ...
        internal DomainsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            RestClient = new DomainsRestClient(clientDiagnostics, pipeline, tenantID, endpoint, apiVersion);
