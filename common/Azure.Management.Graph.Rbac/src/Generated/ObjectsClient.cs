...
namespace Azure.Management.Graph.Rbac
{
    ...
    public partial class ObjectsClient
    {
        ...
        internal ObjectsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            RestClient = new ObjectsRestClient(clientDiagnostics, pipeline, tenantID, endpoint, apiVersion);
