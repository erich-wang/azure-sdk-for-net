...
namespace Azure.Management.Graph.Rbac
{
    ...
    public partial class GroupsClient
    {
        ...
        internal GroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            RestClient = new GroupsRestClient(clientDiagnostics, pipeline, tenantID, endpoint, apiVersion);
