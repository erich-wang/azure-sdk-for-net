...
namespace Azure.Management.Graph.Rbac
{
    ...
    public partial class UsersClient
    {
        ...
        internal UsersClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            RestClient = new UsersRestClient(clientDiagnostics, pipeline, tenantID, endpoint, apiVersion);
