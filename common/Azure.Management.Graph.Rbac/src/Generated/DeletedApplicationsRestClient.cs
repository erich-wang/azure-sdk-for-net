...
namespace Azure.Management.Graph.Rbac
{
    internal partial class DeletedApplicationsRestClient
    {
        ...
        public DeletedApplicationsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            if (tenantID == null)
            {
