...
namespace Azure.Management.Graph.Rbac
{
    ...
    public partial class ApplicationsClient
    {
        ...
        internal ApplicationsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            RestClient = new ApplicationsRestClient(clientDiagnostics, pipeline, tenantID, endpoint, apiVersion);
