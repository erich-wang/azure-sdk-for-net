...
namespace Azure.Management.Graph.Rbac
{
    internal partial class OAuth2PermissionGrantRestClient
    {
        ...
        public OAuth2PermissionGrantRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, Uri endpoint = null, string apiVersion = "1.6")
        {
            if (tenantID == null)
            {
