    ...
    public partial class EHNamespace : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (CreatedAt != null)
            {
                ...
                writer.WriteStringValue(CreatedAt.Value, "S");
            }
            if (UpdatedAt != null)
            {
        ...
        internal static EHNamespace DeserializeEHNamespace(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("createdAt"))
                        {
                            ...
                            createdAt = property0.Value.GetDateTimeOffset("S");
                            continue;
                        }
            ...
            return new EHNamespace(id, name, type, location, tags, sku, provisioningState, createdAt, updatedAt, serviceBusEndpoint, metricId, isAutoInflateEnabled, maximumThroughputUnits, kafkaEnabled);
        }
    }
}
