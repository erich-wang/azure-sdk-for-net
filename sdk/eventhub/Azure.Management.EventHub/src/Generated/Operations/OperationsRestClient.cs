...
namespace Azure.Management.EventHub
{
    internal partial class OperationsRestClient
    {
        ...
        public OperationsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com", string apiVersion = "2017-04-01")
        {
            if (host == null)
            {
