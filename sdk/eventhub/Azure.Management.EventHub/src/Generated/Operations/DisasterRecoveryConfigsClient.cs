...
namespace Azure.Management.EventHub
{
    public partial class DisasterRecoveryConfigsClient
    {
        ...
        internal DisasterRecoveryConfigsRestClient RestClient { get; }
        /// <summary> Initializes a new instance of DisasterRecoveryConfigsClient for mocking. </summary>
        protected DisasterRecoveryConfigsClient()
        {
        }
        /// <summary> Initializes a new instance of DisasterRecoveryConfigsClient. </summary>
        internal DisasterRecoveryConfigsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2017-04-01")
        {
            RestClient = new DisasterRecoveryConfigsRestClient(clientDiagnostics, pipeline, subscriptionId, host, apiVersion);
