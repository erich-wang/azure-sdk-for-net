...
namespace Azure.Management.EventHub
{
    public partial class DisasterRecoveryConfigsClient
    {
        ...
        public DisasterRecoveryConfigsClient(string subscriptionId, TokenCredential tokenCredential) : this(subscriptionId, tokenCredential, EventHubManagementClientOption.Default)
        {
        }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "AZC0007:DO provide a minimal constructor that takes only the parameters required to connect to the service.", Justification = "<Pending>")]
        public DisasterRecoveryConfigsClient(string subscriptionId, TokenCredential tokenCredential, EventHubManagementClientOption options) :
