...
namespace Azure.Management.AppConfiguration
{
    internal partial class OperationsRestClient
    {
        ...
        public OperationsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2019-11-01-preview")
        {
        ...
        internal HttpMessage CreateCheckNameAvailabilityRequest(string name, string type)
        {
            ...
            var model = new CheckNameAvailabilityParameters(name, type);
        ...
        public async ValueTask<Response<NameAvailabilityStatus>> CheckNameAvailabilityAsync(string name, string type = "Microsoft.AppConfiguration/configurationStores", CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
        ...
        /// <param name="type"> The resource type to check for name availability. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<NameAvailabilityStatus> CheckNameAvailability(string name, string type = "Microsoft.AppConfiguration/configurationStores", CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
