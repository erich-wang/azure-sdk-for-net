    ...
    public partial class ConfigurationStore : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (CreationDate != null)
            {
                ...
                writer.WriteStringValue(CreationDate.Value, "S");
            }
            if (Endpoint != null)
            {
        ...
        internal static ConfigurationStore DeserializeConfigurationStore(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("creationDate"))
                        {
                            ...
                            creationDate = property0.Value.GetDateTimeOffset("S");
                            continue;
                        }
            ...
            return new ConfigurationStore(id, name, type, location, tags, identity, sku, provisioningState, creationDate, endpoint, encryption);
        }
    }
}
