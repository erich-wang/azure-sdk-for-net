...
{
    internal partial class DeploymentScriptsRestClient
    {
        ...
        /// <summary> Initializes a new instance of DeploymentScriptsRestClient. </summary>
        public DeploymentScriptsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2019-10-01-preview")
        {
