...
namespace Azure.Management.Resource
{
    internal partial class PolicyAssignmentsRestClient
    {
        ...
        public PolicyAssignmentsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2019-09-01")
        {
