...
namespace Azure.Management.Resource
{
    ...
    public partial class AuthorizationClient
    {
        ...
        public AuthorizationClient(TokenCredential tokenCredential, ResourceManagementClientOptions options = null) : this("https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of AuthorizationClient. </summary>
        public AuthorizationClient(string host, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
            options ??= new ResourceManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new AuthorizationRestClient(_clientDiagnostics, _pipeline, host: host);
        }
