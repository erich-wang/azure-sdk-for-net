...
namespace Azure.Management.Resource
{
    ...
    public partial class ResourceLinksClient
    {
        ...
        internal ResourceLinksRestClient RestClient { get; }
        /// <summary> Initializes a new instance of ResourceLinksClient for mocking. </summary>
        protected ResourceLinksClient()
        {
        }

        /// <summary> Initializes a new instance of ResourceLinksClient. </summary>
        public ResourceLinksClient(string subscriptionId, TokenCredential tokenCredential, ResourceManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of ResourceLinksClient. </summary>
        public ResourceLinksClient(string subscriptionId, string host, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
            options ??= new ResourceManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new ResourceLinksRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResourceLinksClient.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResourceLinksClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResourceLinksClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ResourceLink> ListAtSubscriptionAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ResourceLinksClient.ListAtSubscription");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<ResourceLink> ListAtSourceScopeAsync(string scope, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<ResourceLink>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope0 = _clientDiagnostics.CreateScope("ResourceLinksClient.ListAtSourceScope");
                scope0.Start();
                try
                {
