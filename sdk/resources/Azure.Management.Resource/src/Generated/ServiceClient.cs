...
namespace Azure.Management.Resource
{
    ...
    public partial class ServiceClient
    {
        ...
        public ServiceClient(TokenCredential tokenCredential, ResourceManagementClientOptions options = null) : this("https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of ServiceClient. </summary>
        public ServiceClient(string host, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
