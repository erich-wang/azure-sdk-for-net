...
{
    internal partial class FeaturesRestClient
    {
        ...
        /// <summary> Initializes a new instance of FeaturesRestClient. </summary>
        public FeaturesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2015-12-01")
        {
