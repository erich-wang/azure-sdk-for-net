...
namespace Azure.Management.Resource
{
    internal partial class DeploymentRestClient
    {
        ...
        public DeploymentRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2019-10-01")
        {
