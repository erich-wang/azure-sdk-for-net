...
namespace Azure.Management.Resource.Models
{
    public partial class ManagementLockListResult
    {
        ...
        {
            IReadOnlyList<ManagementLockObject> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    ...
                    List<ManagementLockObject> array = new List<ManagementLockObject>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        ...
                        {
                            array.Add(ManagementLockObject.DeserializeManagementLockObject(item));
                        }
                    }
                    value = array;
                    continue;
