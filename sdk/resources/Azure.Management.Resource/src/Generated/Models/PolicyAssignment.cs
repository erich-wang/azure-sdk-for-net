...
namespace Azure.Management.Resource.Models
{
    ...
    public partial class PolicyAssignment
    {
        ...
        internal PolicyAssignment(string id, string type, string name, PolicySku sku, string location, Identity identity, string displayName, string policyDefinitionId, string scope, IList<string> notScopes, IDictionary<string, ParameterValuesValue> parameters, string description, object metadata, EnforcementMode? enforcementMode)
        {
            Id = id;
            Type = type;
            Name = name;
