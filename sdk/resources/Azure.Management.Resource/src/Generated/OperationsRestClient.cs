...
namespace Azure.Management.Resource
{
    internal partial class OperationsRestClient
    {
        ...
        public OperationsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com", string apiVersion = "2016-09-01")
        {
            if (host == null)
            {
