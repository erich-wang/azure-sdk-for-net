...
{
    internal partial class AuthorizationRestClient
    {
        private string host;
        ...
        /// <summary> Initializes a new instance of AuthorizationRestClient. </summary>
        public AuthorizationRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com", string apiVersion = "2016-09-01")
        {
            if (host == null)
            {
