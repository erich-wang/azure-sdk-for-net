...
namespace Azure.Management.Resource
{
    ...
    public partial class ManagementLocksClient
    {
        ...
        internal ManagementLocksRestClient RestClient { get; }
        /// <summary> Initializes a new instance of ManagementLocksClient for mocking. </summary>
        protected ManagementLocksClient()
        {
        }

        /// <summary> Initializes a new instance of ManagementLocksClient. </summary>
        public ManagementLocksClient(string subscriptionId, TokenCredential tokenCredential, ResourceManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of ManagementLocksClient. </summary>
        public ManagementLocksClient(string subscriptionId, string host, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
            options ??= new ResourceManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new ManagementLocksRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ManagementLocksClient.CreateOrUpdateAtResourceGroupLevel");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ManagementLocksClient.DeleteAtResourceGroupLevel");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ManagementLocksClient.GetAtResourceGroupLevel");
            scope.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.CreateOrUpdateByScope");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.DeleteByScope");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.GetByScope");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.CreateOrUpdateAtResourceLevel");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.DeleteAtResourceLevel");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.GetAtResourceLevel");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.CreateOrUpdateAtSubscriptionLevel");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.DeleteAtSubscriptionLevel");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.GetAtSubscriptionLevel");
            scope0.Start();
            try
            {
        ...
        public virtual AsyncPageable<ManagementLockObject> ListAtResourceGroupLevelAsync(string resourceGroupName, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.ListAtResourceGroupLevel");
                scope0.Start();
                try
                {
        ...
        public virtual AsyncPageable<ManagementLockObject> ListAtResourceLevelAsync(string resourceGroupName, string resourceProviderNamespace, string parentResourcePath, string resourceType, string resourceName, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<ManagementLockObject>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.ListAtResourceLevel");
                scope0.Start();
                try
                {
        ...
        public virtual AsyncPageable<ManagementLockObject> ListAtSubscriptionLevelAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<ManagementLockObject>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.ListAtSubscriptionLevel");
                scope0.Start();
                try
                {
        ...
        public virtual AsyncPageable<ManagementLockObject> ListByScopeAsync(string scope, string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<ManagementLockObject>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope0 = _clientDiagnostics.CreateScope("ManagementLocksClient.ListByScope");
                scope0.Start();
                try
                {
