...
namespace Azure.Management.Resource
{
    internal partial class SubscriptionsRestClient
    {
        ...
        public SubscriptionsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com", string apiVersion = "2019-11-01")
        {
            if (host == null)
            {
