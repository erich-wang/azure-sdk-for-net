...
namespace Azure.Management.Resource
{
    internal partial class ServiceRestClient
    {
        ...
        public ServiceRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com", string apiVersion = "2015-12-01")
        {
            if (host == null)
            {
        ...
        public async ValueTask<Response<OperationListResult>> ListOperationsAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<OperationListResult>> ListOperationsNextPageAsync(string nextLink, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
