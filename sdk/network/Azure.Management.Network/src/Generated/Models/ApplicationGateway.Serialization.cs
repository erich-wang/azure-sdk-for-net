...
namespace Azure.Management.Network.Models
{
    public partial class ApplicationGateway : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGateway DeserializeApplicationGateway(JsonElement element)
        {
            ...
            return new ApplicationGateway(etag, zones, identity, sku, sslPolicy, operationalState, gatewayIPConfigurations, authenticationCertificates, trustedRootCertificates, sslCertificates, frontendIPConfigurations, frontendPorts, probes, backendAddressPools, backendHttpSettingsCollection, httpListeners, urlPathMaps, requestRoutingRules, rewriteRuleSets, redirectConfigurations, webApplicationFirewallConfiguration, firewallPolicy, enableHttp2, enableFips, autoscaleConfiguration, resourceGuid, provisioningState, customErrorConfigurations, id, name, type, location, tags);
        }
    }
}
