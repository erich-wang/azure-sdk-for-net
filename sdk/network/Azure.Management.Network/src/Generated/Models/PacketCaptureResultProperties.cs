...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PacketCaptureResultProperties : PacketCaptureParameters
    {
        ...
        internal PacketCaptureResultProperties(ProvisioningState? provisioningState, string target, int? bytesToCapturePerPacket, int? totalBytesPerSession, int? timeLimitInSeconds, PacketCaptureStorageLocation storageLocation, IList<PacketCaptureFilter> filters) : base(target, bytesToCapturePerPacket, totalBytesPerSession, timeLimitInSeconds, storageLocation, filters)
        {
