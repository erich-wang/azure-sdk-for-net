...
namespace Azure.Management.Network.Models
{
    ...
    public partial class FirewallPolicyRuleGroup : SubResource
    {
        ...
        internal FirewallPolicyRuleGroup(string name, string etag, string type, int? priority, IList<FirewallPolicyRule> rules, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
