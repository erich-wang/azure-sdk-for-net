...
namespace Azure.Management.Network.Models
{
    public partial class VpnConnection : IUtf8JsonSerializable
    {
        ...
        internal static VpnConnection DeserializeVpnConnection(JsonElement element)
        {
            ...
            return new VpnConnection(name, etag, remoteVpnSite, routingWeight, connectionStatus, vpnConnectionProtocolType, ingressBytesTransferred, egressBytesTransferred, connectionBandwidth, sharedKey, enableBgp, usePolicyBasedTrafficSelectors, ipsecPolicies, enableRateLimiting, enableInternetSecurity, useLocalAzureIpAddress, provisioningState, vpnLinkConnections, id);
        }
    }
}
