...
namespace Azure.Management.Network.Models
{
    ...
    public partial class BastionHost : Resource
    {
        ...
        internal BastionHost(string etag, IList<BastionHostIPConfiguration> ipConfigurations, string dnsName, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
