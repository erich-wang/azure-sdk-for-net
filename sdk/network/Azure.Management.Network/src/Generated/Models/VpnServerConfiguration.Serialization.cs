...
namespace Azure.Management.Network.Models
{
    public partial class VpnServerConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VpnServerConfiguration DeserializeVpnServerConfiguration(JsonElement element)
        {
            ...
            return new VpnServerConfiguration(name, etag, name1, vpnProtocols, vpnAuthenticationTypes, vpnClientRootCertificates, vpnClientRevokedCertificates, radiusServerRootCertificates, radiusClientRootCertificates, vpnClientIpsecPolicies, radiusServerAddress, radiusServerSecret, aadAuthenticationParameters, provisioningState, p2SVpnGateways, etag0, id, name, type, location, tags)
            {
                Name = name0
            };
        }
