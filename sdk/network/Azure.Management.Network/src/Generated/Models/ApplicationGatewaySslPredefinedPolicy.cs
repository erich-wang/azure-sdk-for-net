...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewaySslPredefinedPolicy : SubResource
    {
        ...
        internal ApplicationGatewaySslPredefinedPolicy(string name, IList<ApplicationGatewaySslCipherSuite> cipherSuites, ApplicationGatewaySslProtocol? minProtocolVersion, string id) : base(id)
        {
            Name = name;
