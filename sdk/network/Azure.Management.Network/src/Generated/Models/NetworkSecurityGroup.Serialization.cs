...
namespace Azure.Management.Network.Models
{
    public partial class NetworkSecurityGroup : IUtf8JsonSerializable
    {
        ...
        internal static NetworkSecurityGroup DeserializeNetworkSecurityGroup(JsonElement element)
        {
            ...
            return new NetworkSecurityGroup(etag, securityRules, defaultSecurityRules, networkInterfaces, subnets, flowLogs, resourceGuid, provisioningState, id, name, type, location, tags);
        }
    }
}
