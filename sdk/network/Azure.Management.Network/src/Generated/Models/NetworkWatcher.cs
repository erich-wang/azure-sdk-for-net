...
namespace Azure.Management.Network.Models
{
    ...
    public partial class NetworkWatcher : Resource
    {
        ...
        internal NetworkWatcher(string etag, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
