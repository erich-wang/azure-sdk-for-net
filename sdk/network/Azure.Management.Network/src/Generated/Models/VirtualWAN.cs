...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualWAN : Resource
    {
        ...
        internal VirtualWAN(string etag, bool? disableVpnEncryption, IList<SubResource> virtualHubs, IList<SubResource> vpnSites, bool? allowBranchToBranchTraffic, bool? allowVnetToVnetTraffic, OfficeTrafficCategory? office365LocalBreakoutCategory, ProvisioningState? provisioningState, string typePropertiesType, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
