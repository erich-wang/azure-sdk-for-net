...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VpnSiteLink : SubResource
    {
        ...
        internal VpnSiteLink(string etag, string name, string type, VpnLinkProviderProperties linkProperties, string ipAddress, string fqdn, VpnLinkBgpSettings bgpProperties, ProvisioningState? provisioningState, string id) : base(id)
        {
            Etag = etag;
            Name = name;
            Type = type;
