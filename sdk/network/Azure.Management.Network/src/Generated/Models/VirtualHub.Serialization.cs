...
namespace Azure.Management.Network.Models
{
    public partial class VirtualHub : IUtf8JsonSerializable
    {
        ...
        internal static VirtualHub DeserializeVirtualHub(JsonElement element)
        {
            ...
            return new VirtualHub(etag, virtualWan, vpnGateway, p2SVpnGateway, expressRouteGateway, azureFirewall, virtualNetworkConnections, addressPrefix, routeTable, provisioningState, securityProviderName, virtualHubRouteTableV2s, sku, id, name, type, location, tags);
        }
    }
}
