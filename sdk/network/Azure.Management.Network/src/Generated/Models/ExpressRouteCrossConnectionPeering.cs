...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnectionPeering : SubResource
    {
        ...
        internal ExpressRouteCrossConnectionPeering(string name, string etag, ExpressRoutePeeringType? peeringType, ExpressRoutePeeringState? state, int? azureASN, long? peerASN, string primaryPeerAddressPrefix, string secondaryPeerAddressPrefix, string primaryAzurePort, string secondaryAzurePort, string sharedKey, int? vlanId, ExpressRouteCircuitPeeringConfig microsoftPeeringConfig, ProvisioningState? provisioningState, string gatewayManagerEtag, string lastModifiedBy, Ipv6ExpressRouteCircuitPeeringConfig ipv6PeeringConfig, string id) : base(id)
        {
            Name = name;
            Etag = etag;
