...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PublicIPPrefix : Resource
    {
        ...
        internal PublicIPPrefix(PublicIPPrefixSku sku, string etag, IList<string> zones, IPVersion? publicIPAddressVersion, IList<IpTag> ipTags, int? prefixLength, string ipPrefix, IList<ReferencedPublicIpAddress> publicIPAddresses, SubResource loadBalancerFrontendIpConfiguration, string resourceGuid, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Sku = sku;
            Etag = etag;
            Zones = zones;
