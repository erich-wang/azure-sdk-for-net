...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PrivateLinkServiceConnection : SubResource
    {
        ...
        internal PrivateLinkServiceConnection(string name, string type, string etag, ProvisioningState? provisioningState, string privateLinkServiceId, IList<string> groupIds, string requestMessage, PrivateLinkServiceConnectionState privateLinkServiceConnectionState, string id) : base(id)
        {
            Name = name;
            Type = type;
            Etag = etag;
