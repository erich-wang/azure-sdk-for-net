...
namespace Azure.Management.Network.Models
{
    public partial class NetworkRuleCondition : IUtf8JsonSerializable
    {
        ...
        internal static NetworkRuleCondition DeserializeNetworkRuleCondition(JsonElement element)
        {
            ...
            return new NetworkRuleCondition(ipProtocols, sourceAddresses, destinationAddresses, destinationPorts, sourceIpGroups, destinationIpGroups, name, description, ruleConditionType);
        }
    }
}
