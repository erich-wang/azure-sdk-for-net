...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteServiceProvider : Resource
    {
        ...
        internal ExpressRouteServiceProvider(IList<string> peeringLocations, IList<ExpressRouteServiceProviderBandwidthsOffered> bandwidthsOffered, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
