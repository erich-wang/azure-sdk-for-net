...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ConnectivityIssue
    {
        ...
        internal ConnectivityIssue(Origin? origin, Severity? severity, IssueType? type, IReadOnlyList<IReadOnlyDictionary<string, string>> context)
        {
            Origin = origin;
            Severity = severity;
            Type = type;
        ...
        public IReadOnlyList<IReadOnlyDictionary<string, string>> Context { get; }
    }
}
