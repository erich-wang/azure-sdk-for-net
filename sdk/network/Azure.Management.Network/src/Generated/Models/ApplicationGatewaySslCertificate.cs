...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewaySslCertificate : SubResource
    {
        ...
        internal ApplicationGatewaySslCertificate(string name, string etag, string type, string data, string password, string publicCertData, string keyVaultSecretId, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
