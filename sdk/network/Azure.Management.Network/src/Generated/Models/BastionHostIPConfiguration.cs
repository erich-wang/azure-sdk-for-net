...
namespace Azure.Management.Network.Models
{
    ...
    public partial class BastionHostIPConfiguration : SubResource
    {
        ...
        internal BastionHostIPConfiguration(string name, string etag, string type, SubResource subnet, SubResource publicIPAddress, ProvisioningState? provisioningState, IPAllocationMethod? privateIPAllocationMethod, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
