...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRoutePortsLocation : Resource
    {
        ...
        internal ExpressRoutePortsLocation(string address, string contact, IList<ExpressRoutePortsLocationBandwidths> availableBandwidths, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Address = address;
            Contact = contact;
