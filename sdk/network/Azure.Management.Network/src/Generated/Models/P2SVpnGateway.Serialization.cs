...
namespace Azure.Management.Network.Models
{
    public partial class P2SVpnGateway : IUtf8JsonSerializable
    {
        ...
        internal static P2SVpnGateway DeserializeP2SVpnGateway(JsonElement element)
        {
            ...
            return new P2SVpnGateway(etag, virtualHub, p2SConnectionConfigurations, provisioningState, vpnGatewayScaleUnit, vpnServerConfiguration, vpnClientConnectionHealth, id, name, type, location, tags);
        }
    }
}
