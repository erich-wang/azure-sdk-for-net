...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ContainerNetworkInterfaceConfiguration : SubResource
    {
        ...
        internal ContainerNetworkInterfaceConfiguration(string name, string type, string etag, IList<IPConfigurationProfile> ipConfigurations, IList<SubResource> containerNetworkInterfaces, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Type = type;
            Etag = etag;
