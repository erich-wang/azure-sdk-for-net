...
namespace Azure.Management.Network.Models
{
    public partial class ApplicationGatewayPathRule : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewayPathRule DeserializeApplicationGatewayPathRule(JsonElement element)
        {
            ...
            return new ApplicationGatewayPathRule(name, etag, type, paths, backendAddressPool, backendHttpSettings, redirectConfiguration, rewriteRuleSet, provisioningState, firewallPolicy, id);
        }
    }
}
