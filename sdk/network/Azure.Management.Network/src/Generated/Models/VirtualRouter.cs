...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualRouter : Resource
    {
        ...
        internal VirtualRouter(string etag, long? virtualRouterAsn, IList<string> virtualRouterIps, SubResource hostedSubnet, SubResource hostedGateway, IList<SubResource> peerings, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
