...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayRewriteRuleSet : SubResource
    {
        ...
        internal ApplicationGatewayRewriteRuleSet(string name, string etag, IList<ApplicationGatewayRewriteRule> rewriteRules, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
