...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VpnConnection : SubResource
    {
        ...
        internal VpnConnection(string name, string etag, SubResource remoteVpnSite, int? routingWeight, VpnConnectionStatus? connectionStatus, VirtualNetworkGatewayConnectionProtocol? vpnConnectionProtocolType, long? ingressBytesTransferred, long? egressBytesTransferred, int? connectionBandwidth, string sharedKey, bool? enableBgp, bool? usePolicyBasedTrafficSelectors, IList<IpsecPolicy> ipsecPolicies, bool? enableRateLimiting, bool? enableInternetSecurity, bool? useLocalAzureIpAddress, ProvisioningState? provisioningState, IList<VpnSiteLinkConnection> vpnLinkConnections, string id) : base(id)
        {
            Name = name;
            Etag = etag;
        ...
        public VpnConnectionStatus? ConnectionStatus { get; set; }
