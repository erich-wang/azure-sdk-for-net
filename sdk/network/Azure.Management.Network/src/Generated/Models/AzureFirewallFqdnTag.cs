...
namespace Azure.Management.Network.Models
{
    ...
    public partial class AzureFirewallFqdnTag : Resource
    {
        ...
        internal AzureFirewallFqdnTag(string etag, ProvisioningState? provisioningState, string fqdnTagName, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
