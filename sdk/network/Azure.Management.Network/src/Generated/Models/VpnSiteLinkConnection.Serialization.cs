...
namespace Azure.Management.Network.Models
{
    public partial class VpnSiteLinkConnection : IUtf8JsonSerializable
    {
        ...
        internal static VpnSiteLinkConnection DeserializeVpnSiteLinkConnection(JsonElement element)
        {
            ...
            return new VpnSiteLinkConnection(name, etag, type, vpnSiteLink, routingWeight, connectionStatus, vpnConnectionProtocolType, ingressBytesTransferred, egressBytesTransferred, connectionBandwidth, sharedKey, enableBgp, usePolicyBasedTrafficSelectors, ipsecPolicies, enableRateLimiting, useLocalAzureIpAddress, provisioningState, id);
        }
    }
}
