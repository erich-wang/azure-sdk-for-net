...
namespace Azure.Management.Network.Models
{
    ...
    public partial class DdosCustomPolicy : Resource
    {
        ...
        internal DdosCustomPolicy(string etag, string resourceGuid, ProvisioningState? provisioningState, IList<SubResource> publicIPAddresses, IList<ProtocolCustomSettingsFormat> protocolCustomSettings, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
