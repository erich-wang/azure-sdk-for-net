...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRoutePort : Resource
    {
        ...
        internal ExpressRoutePort(string etag, ManagedServiceIdentity identity, string peeringLocation, int? bandwidthInGbps, float? provisionedBandwidthInGbps, string mtu, ExpressRoutePortsEncapsulation? encapsulation, string etherType, string allocationDate, IList<ExpressRouteLink> links, IList<SubResource> circuits, ProvisioningState? provisioningState, string resourceGuid, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
            Identity = identity;
