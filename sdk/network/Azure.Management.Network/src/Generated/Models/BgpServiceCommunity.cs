...
namespace Azure.Management.Network.Models
{
    ...
    public partial class BgpServiceCommunity : Resource
    {
        ...
        internal BgpServiceCommunity(string serviceName, IList<BGPCommunity> bgpCommunities, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
