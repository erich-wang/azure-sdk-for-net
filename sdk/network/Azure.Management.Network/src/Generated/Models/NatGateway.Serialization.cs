...
namespace Azure.Management.Network.Models
{
    public partial class NatGateway : IUtf8JsonSerializable
    {
        ...
        internal static NatGateway DeserializeNatGateway(JsonElement element)
        {
            ...
            return new NatGateway(sku, zones, etag, idleTimeoutInMinutes, publicIpAddresses, publicIpPrefixes, subnets, resourceGuid, provisioningState, id, name, type, location, tags);
        }
    }
}
