...
namespace Azure.Management.Network.Models
{
    ...
    public partial class BgpPeerStatus
    {
        ...
        internal BgpPeerStatus(string localAddress, string neighbor, int? asn, BgpPeerState? state, string connectedDuration, long? routesReceived, long? messagesSent, long? messagesReceived)
        {
