...
namespace Azure.Management.Network.Models
{
    ...
    public partial class FirewallPolicyNatRule : FirewallPolicyRule
    {
        ...
        internal FirewallPolicyNatRule(FirewallPolicyNatRuleAction action, string translatedAddress, string translatedPort, FirewallPolicyRuleCondition ruleCondition, FirewallPolicyRuleType ruleType, string name, int? priority) : base(ruleType, name, priority)
        {
            Action = action;
            TranslatedAddress = translatedAddress;
            TranslatedPort = translatedPort;
            RuleCondition = ruleCondition;
            RuleType = ruleType ?? "FirewallPolicyNatRule";
        }
