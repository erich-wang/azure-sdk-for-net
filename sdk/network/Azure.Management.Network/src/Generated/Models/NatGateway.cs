...
namespace Azure.Management.Network.Models
{
    ...
    public partial class NatGateway : Resource
    {
        ...
        internal NatGateway(NatGatewaySku sku, IList<string> zones, string etag, int? idleTimeoutInMinutes, IList<SubResource> publicIpAddresses, IList<SubResource> publicIpPrefixes, IList<SubResource> subnets, string resourceGuid, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Sku = sku;
            Zones = zones;
            Etag = etag;
