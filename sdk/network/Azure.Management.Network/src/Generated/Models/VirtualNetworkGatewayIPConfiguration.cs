...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayIPConfiguration : SubResource
    {
        ...
        internal VirtualNetworkGatewayIPConfiguration(string name, string etag, IPAllocationMethod? privateIPAllocationMethod, SubResource subnet, SubResource publicIPAddress, string privateIPAddress, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
