...
namespace Azure.Management.Network.Models
{
    public partial class LocalNetworkGateway : IUtf8JsonSerializable
    {
        ...
        internal static LocalNetworkGateway DeserializeLocalNetworkGateway(JsonElement element)
        {
            ...
            return new LocalNetworkGateway(etag, localNetworkAddressSpace, gatewayIpAddress, fqdn, bgpSettings, resourceGuid, provisioningState, id, name, type, location, tags);
        }
    }
}
