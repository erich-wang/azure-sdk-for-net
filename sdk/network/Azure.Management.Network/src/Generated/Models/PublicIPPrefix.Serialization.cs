...
namespace Azure.Management.Network.Models
{
    public partial class PublicIPPrefix : IUtf8JsonSerializable
    {
        ...
        internal static PublicIPPrefix DeserializePublicIPPrefix(JsonElement element)
        {
            ...
            return new PublicIPPrefix(sku, etag, zones, publicIPAddressVersion, ipTags, prefixLength, ipPrefix, publicIPAddresses, loadBalancerFrontendIpConfiguration, resourceGuid, provisioningState, id, name, type, location, tags);
        }
    }
}
