...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PrivateEndpointConnection : SubResource
    {
        ...
        internal PrivateEndpointConnection(string name, string type, string etag, PrivateEndpoint privateEndpoint, PrivateLinkServiceConnectionState privateLinkServiceConnectionState, ProvisioningState? provisioningState, string linkIdentifier, string id) : base(id)
        {
            Name = name;
            Type = type;
            Etag = etag;
