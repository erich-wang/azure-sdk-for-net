...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PeerExpressRouteCircuitConnection : SubResource
    {
        ...
        internal PeerExpressRouteCircuitConnection(string name, string etag, string type, SubResource expressRouteCircuitPeering, SubResource peerExpressRouteCircuitPeering, string addressPrefix, CircuitConnectionStatus? circuitConnectionStatus, string connectionName, string authResourceGuid, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
