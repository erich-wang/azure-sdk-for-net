...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteConnection : SubResource
    {
        ...
        internal ExpressRouteConnection(string name, ProvisioningState? provisioningState, ExpressRouteCircuitPeeringId expressRouteCircuitPeering, string authorizationKey, int? routingWeight, bool? enableInternetSecurity, string id) : base(id)
        {
            Name = name;
