...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteConnection : SubResource
    {
        ...
        internal ExpressRouteConnection(string id, string name, ProvisioningState? provisioningState, ExpressRouteCircuitPeeringId expressRouteCircuitPeering, string authorizationKey, int? routingWeight, bool? enableInternetSecurity) : base(id)
        {
            Name = name;
