...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteCircuitAuthorization : SubResource
    {
        ...
        internal ExpressRouteCircuitAuthorization(string name, string etag, string type, string authorizationKey, AuthorizationUseStatus? authorizationUseStatus, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
