...
namespace Azure.Management.Network.Models
{
    public partial class WebApplicationFirewallPolicy : IUtf8JsonSerializable
    {
        ...
        internal static WebApplicationFirewallPolicy DeserializeWebApplicationFirewallPolicy(JsonElement element)
        {
            ...
            return new WebApplicationFirewallPolicy(etag, policySettings, customRules, applicationGateways, provisioningState, resourceState, managedRules, httpListeners, pathBasedRules, id, name, type, location, tags);
        }
    }
}
