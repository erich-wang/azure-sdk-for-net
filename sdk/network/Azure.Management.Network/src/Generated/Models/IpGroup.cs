...
namespace Azure.Management.Network.Models
{
    ...
    public partial class IpGroup : Resource
    {
        ...
        internal IpGroup(string etag, ProvisioningState? provisioningState, IList<string> ipAddresses, IList<SubResource> firewalls, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
