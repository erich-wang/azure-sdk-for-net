...
namespace Azure.Management.Network.Models
{
    public partial class VirtualNetwork : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetwork DeserializeVirtualNetwork(JsonElement element)
        {
            ...
            return new VirtualNetwork(etag, addressSpace, dhcpOptions, subnets, virtualNetworkPeerings, resourceGuid, provisioningState, enableDdosProtection, enableVmProtection, ddosProtectionPlan, bgpCommunities, id, name, type, location, tags);
        }
    }
}
