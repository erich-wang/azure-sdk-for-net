...
namespace Azure.Management.Network.Models
{
    ...
    public partial class RouteFilterRule : SubResource
    {
        ...
        internal RouteFilterRule(string name, string location, string etag, Access? access, string routeFilterRuleType, IList<string> communities, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Location = location;
            Etag = etag;
