...
namespace Azure.Management.Network.Models
{
    public partial class VirtualWAN : IUtf8JsonSerializable
    {
        ...
        internal static VirtualWAN DeserializeVirtualWAN(JsonElement element)
        {
            ...
            return new VirtualWAN(etag, disableVpnEncryption, virtualHubs, vpnSites, allowBranchToBranchTraffic, allowVnetToVnetTraffic, office365LocalBreakoutCategory, provisioningState, type0, id, name, type, location, tags);
        }
    }
}
