...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayIPConfiguration : SubResource
    {
        ...
        internal ApplicationGatewayIPConfiguration(string name, string etag, string type, SubResource subnet, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
