...
namespace Azure.Management.Network.Models
{
    public partial class PeerExpressRouteCircuitConnection : IUtf8JsonSerializable
    {
        ...
        internal static PeerExpressRouteCircuitConnection DeserializePeerExpressRouteCircuitConnection(JsonElement element)
        {
            ...
            return new PeerExpressRouteCircuitConnection(name, etag, type, expressRouteCircuitPeering, peerExpressRouteCircuitPeering, addressPrefix, circuitConnectionStatus, connectionName, authResourceGuid, provisioningState, id);
        }
    }
}
