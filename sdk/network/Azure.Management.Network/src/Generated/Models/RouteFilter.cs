...
namespace Azure.Management.Network.Models
{
    ...
    public partial class RouteFilter : Resource
    {
        ...
        internal RouteFilter(string etag, IList<RouteFilterRule> rules, IList<ExpressRouteCircuitPeering> peerings, IList<ExpressRouteCircuitPeering> ipv6Peerings, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
            Rules = rules;
            Peerings = peerings;
