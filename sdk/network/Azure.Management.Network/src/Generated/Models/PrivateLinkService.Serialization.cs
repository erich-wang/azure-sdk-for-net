...
namespace Azure.Management.Network.Models
{
    public partial class PrivateLinkService : IUtf8JsonSerializable
    {
        ...
        internal static PrivateLinkService DeserializePrivateLinkService(JsonElement element)
        {
            ...
            return new PrivateLinkService(etag, loadBalancerFrontendIpConfigurations, ipConfigurations, networkInterfaces, provisioningState, privateEndpointConnections, visibility, autoApproval, fqdns, alias, enableProxyProtocol, id, name, type, location, tags);
        }
    }
}
