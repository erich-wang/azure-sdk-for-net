...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayRedirectConfiguration : SubResource
    {
        ...
        internal ApplicationGatewayRedirectConfiguration(string name, string etag, string type, ApplicationGatewayRedirectType? redirectType, SubResource targetListener, string targetUrl, bool? includePath, bool? includeQueryString, IList<SubResource> requestRoutingRules, IList<SubResource> urlPathMaps, IList<SubResource> pathRules, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
