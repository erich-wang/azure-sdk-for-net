...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCrossConnectionPeering : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteCrossConnectionPeering DeserializeExpressRouteCrossConnectionPeering(JsonElement element)
        {
            ...
            return new ExpressRouteCrossConnectionPeering(name, etag, peeringType, state, azureASN, peerASN, primaryPeerAddressPrefix, secondaryPeerAddressPrefix, primaryAzurePort, secondaryAzurePort, sharedKey, vlanId, microsoftPeeringConfig, provisioningState, gatewayManagerEtag, lastModifiedBy, ipv6PeeringConfig, id);
        }
    }
}
