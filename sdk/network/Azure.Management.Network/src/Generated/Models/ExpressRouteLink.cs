...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteLink : SubResource
    {
        ...
        internal ExpressRouteLink(string name, string etag, string routerName, string interfaceName, string patchPanelId, string rackId, ExpressRouteLinkConnectorType? connectorType, ExpressRouteLinkAdminState? adminState, ProvisioningState? provisioningState, ExpressRouteLinkMacSecConfig macSecConfig, string id) : base(id)
        {
            Name = name;
            Etag = etag;
