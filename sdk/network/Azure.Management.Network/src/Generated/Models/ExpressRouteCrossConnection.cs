...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteCrossConnection : Resource
    {
        ...
        internal ExpressRouteCrossConnection(string etag, string primaryAzurePort, string secondaryAzurePort, int? sTag, string peeringLocation, int? bandwidthInMbps, ExpressRouteCircuitReference expressRouteCircuit, ServiceProviderProvisioningState? serviceProviderProvisioningState, string serviceProviderNotes, ProvisioningState? provisioningState, IList<ExpressRouteCrossConnectionPeering> peerings, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
