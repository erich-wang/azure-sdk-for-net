...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayAuthenticationCertificate : SubResource
    {
        ...
        internal ApplicationGatewayAuthenticationCertificate(string name, string etag, string type, string data, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
