...
namespace Azure.Management.Network.Models
{
    ...
    public partial class NetworkIntentPolicy : Resource
    {
        ...
        internal NetworkIntentPolicy(string etag, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
        }
