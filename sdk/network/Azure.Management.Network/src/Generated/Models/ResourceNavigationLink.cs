...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ResourceNavigationLink : SubResource
    {
        ...
        /// <param name="id"> Resource navigation link identifier. </param>
        ...
        internal ResourceNavigationLink(string name, string id, string etag, string type, string linkedResourceType, string link, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Id = id;
            Etag = etag;
        ...
        /// <summary> Resource navigation link identifier. </summary>
