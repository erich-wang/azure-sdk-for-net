...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationRuleCondition : FirewallPolicyRuleCondition
    {
        ...
        internal ApplicationRuleCondition(IList<string> sourceAddresses, IList<string> destinationAddresses, IList<FirewallPolicyRuleConditionApplicationProtocol> protocols, IList<string> targetFqdns, IList<string> fqdnTags, IList<string> sourceIpGroups, string name, string description, FirewallPolicyRuleConditionType ruleConditionType) : base(name, description, ruleConditionType)
        {
            ...
            RuleConditionType = ruleConditionType ?? "ApplicationRuleCondition";
        }
