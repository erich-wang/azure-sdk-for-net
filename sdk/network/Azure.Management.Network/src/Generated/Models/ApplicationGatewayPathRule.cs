...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayPathRule : SubResource
    {
        ...
        internal ApplicationGatewayPathRule(string name, string etag, string type, IList<string> paths, SubResource backendAddressPool, SubResource backendHttpSettings, SubResource redirectConfiguration, SubResource rewriteRuleSet, ProvisioningState? provisioningState, SubResource firewallPolicy, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
