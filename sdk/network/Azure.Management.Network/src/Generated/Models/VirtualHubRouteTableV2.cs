...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualHubRouteTableV2 : SubResource
    {
        ...
        internal VirtualHubRouteTableV2(string name, string etag, IList<VirtualHubRouteV2> routes, IList<string> attachedConnections, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Routes = routes;
