...
namespace Azure.Management.Network.Models
{
    public partial class FlowLog : IUtf8JsonSerializable
    {
        ...
        internal static FlowLog DeserializeFlowLog(JsonElement element)
        {
            ...
            return new FlowLog(etag, targetResourceId, targetResourceGuid, storageId, enabled, retentionPolicy, format, flowAnalyticsConfiguration, provisioningState, id, name, type, location, tags);
        }
    }
}
