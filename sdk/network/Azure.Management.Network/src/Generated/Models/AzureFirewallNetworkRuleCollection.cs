...
namespace Azure.Management.Network.Models
{
    ...
    public partial class AzureFirewallNetworkRuleCollection : SubResource
    {
        ...
        internal AzureFirewallNetworkRuleCollection(string name, string etag, int? priority, AzureFirewallRCAction action, IList<AzureFirewallNetworkRule> rules, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Priority = priority;
