...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayUrlPathMap : SubResource
    {
        ...
        internal ApplicationGatewayUrlPathMap(string name, string etag, string type, SubResource defaultBackendAddressPool, SubResource defaultBackendHttpSettings, SubResource defaultRewriteRuleSet, SubResource defaultRedirectConfiguration, IList<ApplicationGatewayPathRule> pathRules, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
