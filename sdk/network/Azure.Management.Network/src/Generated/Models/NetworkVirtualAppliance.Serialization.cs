...
namespace Azure.Management.Network.Models
{
    public partial class NetworkVirtualAppliance : IUtf8JsonSerializable
    {
        ...
        internal static NetworkVirtualAppliance DeserializeNetworkVirtualAppliance(JsonElement element)
        {
            ...
            return new NetworkVirtualAppliance(identity, sku, etag, bootStrapConfigurationBlob, virtualHub, cloudInitConfigurationBlob, virtualApplianceAsn, virtualApplianceNics, provisioningState, id, name, type, location, tags);
        }
    }
}
