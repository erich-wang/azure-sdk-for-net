...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCrossConnection : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteCrossConnection DeserializeExpressRouteCrossConnection(JsonElement element)
        {
            ...
            return new ExpressRouteCrossConnection(etag, primaryAzurePort, secondaryAzurePort, sTag, peeringLocation, bandwidthInMbps, expressRouteCircuit, serviceProviderProvisioningState, serviceProviderNotes, provisioningState, peerings, id, name, type, location, tags);
        }
    }
}
