...
namespace Azure.Management.Network.Models
{
    ...
    public partial class LocalNetworkGateway : Resource
    {
        ...
        internal LocalNetworkGateway(string etag, AddressSpace localNetworkAddressSpace, string gatewayIpAddress, string fqdn, BgpSettings bgpSettings, string resourceGuid, ProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
