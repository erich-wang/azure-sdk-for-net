...
namespace Azure.Management.Network.Models
{
    ...
    public partial class NatRuleCondition : FirewallPolicyRuleCondition
    {
        ...
        internal NatRuleCondition(string name, string description, FirewallPolicyRuleConditionType ruleConditionType, IList<FirewallPolicyRuleConditionNetworkProtocol> ipProtocols, IList<string> sourceAddresses, IList<string> destinationAddresses, IList<string> destinationPorts, IList<string> sourceIpGroups) : base(name, description, ruleConditionType)
        {
