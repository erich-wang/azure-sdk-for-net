...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetwork : Resource
    {
        ...
        internal VirtualNetwork(string etag, AddressSpace addressSpace, DhcpOptions dhcpOptions, IList<Subnet> subnets, IList<VirtualNetworkPeering> virtualNetworkPeerings, string resourceGuid, ProvisioningState? provisioningState, bool? enableDdosProtection, bool? enableVmProtection, SubResource ddosProtectionPlan, VirtualNetworkBgpCommunities bgpCommunities, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
