...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayTrustedRootCertificate : SubResource
    {
        ...
        internal ApplicationGatewayTrustedRootCertificate(string name, string etag, string type, string data, string keyVaultSecretId, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
