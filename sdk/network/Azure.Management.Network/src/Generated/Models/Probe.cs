...
namespace Azure.Management.Network.Models
{
    ...
    public partial class Probe : SubResource
    {
        ...
        internal Probe(string name, string etag, string type, IList<SubResource> loadBalancingRules, ProbeProtocol? protocol, int? port, int? intervalInSeconds, int? numberOfProbes, string requestPath, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
