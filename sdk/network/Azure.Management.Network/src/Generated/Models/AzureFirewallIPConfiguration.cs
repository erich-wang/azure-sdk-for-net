...
namespace Azure.Management.Network.Models
{
    ...
    public partial class AzureFirewallIPConfiguration : SubResource
    {
        ...
        internal AzureFirewallIPConfiguration(string name, string etag, string type, string privateIPAddress, SubResource subnet, SubResource publicIPAddress, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
