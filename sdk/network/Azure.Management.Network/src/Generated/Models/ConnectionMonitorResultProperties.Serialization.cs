...
namespace Azure.Management.Network.Models
{
    public partial class ConnectionMonitorResultProperties : IUtf8JsonSerializable
    {
        ...
        internal static ConnectionMonitorResultProperties DeserializeConnectionMonitorResultProperties(JsonElement element)
        {
            ...
            return new ConnectionMonitorResultProperties(provisioningState, startTime, monitoringStatus, connectionMonitorType, source, destination, autoStart, monitoringIntervalInSeconds, endpoints, testConfigurations, testGroups, outputs, notes);
        }
    }
}
