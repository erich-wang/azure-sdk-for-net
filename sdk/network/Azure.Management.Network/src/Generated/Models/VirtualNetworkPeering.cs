...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetworkPeering : SubResource
    {
        ...
        internal VirtualNetworkPeering(string name, string etag, bool? allowVirtualNetworkAccess, bool? allowForwardedTraffic, bool? allowGatewayTransit, bool? useRemoteGateways, SubResource remoteVirtualNetwork, AddressSpace remoteAddressSpace, VirtualNetworkPeeringState? peeringState, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
