...
namespace Azure.Management.Network.Models
{
    ...
    public partial class AzureFirewallNatRuleCollection : SubResource
    {
        ...
        internal AzureFirewallNatRuleCollection(string name, string etag, int? priority, AzureFirewallNatRCAction action, IList<AzureFirewallNatRule> rules, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Priority = priority;
