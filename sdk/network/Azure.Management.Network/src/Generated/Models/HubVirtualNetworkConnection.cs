...
namespace Azure.Management.Network.Models
{
    ...
    public partial class HubVirtualNetworkConnection : SubResource
    {
        ...
        internal HubVirtualNetworkConnection(string name, string etag, SubResource remoteVirtualNetwork, bool? allowHubToRemoteVnetTransit, bool? allowRemoteVnetToUseHubVnetGateways, bool? enableInternetSecurity, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
