...
namespace Azure.Management.Network.Models
{
    ...
    public partial class HubVirtualNetworkConnection : SubResource
    {
        ...
        internal HubVirtualNetworkConnection(string id, string name, string etag, SubResource remoteVirtualNetwork, bool? allowHubToRemoteVnetTransit, bool? allowRemoteVnetToUseHubVnetGateways, bool? enableInternetSecurity, ProvisioningState? provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
