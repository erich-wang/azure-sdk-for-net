...
namespace Azure.Management.Network.Models
{
    ...
    public partial class FirewallPolicy : Resource
    {
        ...
        internal FirewallPolicy(string etag, IList<SubResource> ruleGroups, ProvisioningState? provisioningState, SubResource basePolicy, IList<SubResource> firewalls, IList<SubResource> childPolicies, AzureFirewallThreatIntelMode? threatIntelMode, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
