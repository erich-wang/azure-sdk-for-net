...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayFrontendIPConfiguration : SubResource
    {
        ...
        internal ApplicationGatewayFrontendIPConfiguration(string name, string etag, string type, string privateIPAddress, IPAllocationMethod? privateIPAllocationMethod, SubResource subnet, SubResource publicIPAddress, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
