...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VpnGateway : Resource
    {
        ...
        internal VpnGateway(string etag, SubResource virtualHub, IList<VpnConnection> connections, BgpSettings bgpSettings, ProvisioningState? provisioningState, int? vpnGatewayScaleUnit, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            Etag = etag;
