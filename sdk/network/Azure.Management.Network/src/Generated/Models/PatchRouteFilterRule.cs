...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PatchRouteFilterRule : SubResource
    {
        ...
        internal PatchRouteFilterRule(string name, string etag, Access? access, string routeFilterRuleType, IList<string> communities, ProvisioningState? provisioningState, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Access = access;
