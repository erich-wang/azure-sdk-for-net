...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PrivateLinkServiceIpConfiguration : SubResource
    {
        ...
        internal PrivateLinkServiceIpConfiguration(string name, string etag, string type, string privateIPAddress, IPAllocationMethod? privateIPAllocationMethod, Subnet subnet, bool? primary, ProvisioningState? provisioningState, IPVersion? privateIPAddressVersion, string id) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
