...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRoutePort : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRoutePort DeserializeExpressRoutePort(JsonElement element)
        {
            ...
            return new ExpressRoutePort(etag, identity, peeringLocation, bandwidthInGbps, provisionedBandwidthInGbps, mtu, encapsulation, etherType, allocationDate, links, circuits, provisioningState, resourceGuid, id, name, type, location, tags);
        }
    }
}
