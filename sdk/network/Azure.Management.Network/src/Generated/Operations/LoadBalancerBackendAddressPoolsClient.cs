...
namespace Azure.Management.Network
{
    ...
    public partial class LoadBalancerBackendAddressPoolsClient
    {
        ...
        public LoadBalancerBackendAddressPoolsClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new LoadBalancerBackendAddressPoolsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
