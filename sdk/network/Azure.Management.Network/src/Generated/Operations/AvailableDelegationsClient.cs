...
namespace Azure.Management.Network
{
    ...
    public partial class AvailableDelegationsClient
    {
        ...
        public AvailableDelegationsClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new AvailableDelegationsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
