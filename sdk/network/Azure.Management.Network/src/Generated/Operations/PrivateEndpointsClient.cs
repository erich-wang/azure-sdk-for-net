...
namespace Azure.Management.Network
{
    public partial class PrivateEndpointsClient
    {
        ...
        internal PrivateEndpointsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new PrivateEndpointsRestClient(clientDiagnostics, pipeline, subscriptionId, host);
        ...
        public virtual async Task<Response<PrivateEndpoint>> GetAsync(string resourceGroupName, string privateEndpointName, string expand, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> Expands BackendAddressPool and BackendHttpSettings referenced in backend health. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<PrivateEndpoint> Get(string resourceGroupName, string privateEndpointName, string expand, CancellationToken cancellationToken = default)
        {
        ...
        internal Operation<Response> CreateDelete(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Delete, "PrivateEndpointsClient.Delete", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<PrivateEndpoint> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Put, "PrivateEndpointsClient.CreateOrUpdate", OperationFinalStateVia.AzureAsyncOperation, createOriginalHttpMessage,
