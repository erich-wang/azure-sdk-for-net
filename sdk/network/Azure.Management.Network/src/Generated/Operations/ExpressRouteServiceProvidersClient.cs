...
namespace Azure.Management.Network
{
    ...
    public partial class ExpressRouteServiceProvidersClient
    {
        ...
        public ExpressRouteServiceProvidersClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new ExpressRouteServiceProvidersRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
