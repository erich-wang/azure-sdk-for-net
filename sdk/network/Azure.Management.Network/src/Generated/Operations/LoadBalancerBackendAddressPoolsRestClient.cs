...
{
    internal partial class LoadBalancerBackendAddressPoolsRestClient
    {
        ...
        /// <summary> Initializes a new instance of LoadBalancerBackendAddressPoolsRestClient. </summary>
        public LoadBalancerBackendAddressPoolsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
        ...
        public async ValueTask<Response<LoadBalancerBackendAddressPoolListResult>> ListAsync(string resourceGroupName, string loadBalancerName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("LoadBalancerBackendAddressPoolsClient.List");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<BackendAddressPool>> GetAsync(string resourceGroupName, string loadBalancerName, string backendAddressPoolName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("LoadBalancerBackendAddressPoolsClient.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<LoadBalancerBackendAddressPoolListResult>> ListNextPageAsync(string nextLink, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
        ...
        /// <param name="nextLink"> The URL to the next page of results. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<LoadBalancerBackendAddressPoolListResult> ListNextPage(string nextLink, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
