...
{
    internal partial class ExpressRouteGatewaysRestClient
    {
        ...
        /// <summary> Initializes a new instance of ExpressRouteGatewaysRestClient. </summary>
        public ExpressRouteGatewaysRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteGatewaysClient.ListBySubscription");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<ExpressRouteGatewayList>> ListByResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteGatewaysClient.ListByResourceGroup");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string expressRouteGatewayName, ExpressRouteGateway putExpressRouteGatewayParameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async ValueTask<Response> CreateOrUpdateAsync(string resourceGroupName, string expressRouteGatewayName, ExpressRouteGateway putExpressRouteGatewayParameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteGatewaysClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<ExpressRouteGateway>> GetAsync(string resourceGroupName, string expressRouteGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteGatewaysClient.Get");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response> DeleteAsync(string resourceGroupName, string expressRouteGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteGatewaysClient.Delete");
            scope.Start();
            try
            {
