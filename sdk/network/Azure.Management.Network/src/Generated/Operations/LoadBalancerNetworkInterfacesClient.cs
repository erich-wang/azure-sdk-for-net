...
namespace Azure.Management.Network
{
    ...
    public partial class LoadBalancerNetworkInterfacesClient
    {
        ...
        public LoadBalancerNetworkInterfacesClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new LoadBalancerNetworkInterfacesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
