...
namespace Azure.Management.Network
{
    public partial class ExpressRouteCircuitConnectionsClient
    {
        ...
        internal ExpressRouteCircuitConnectionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new ExpressRouteCircuitConnectionsRestClient(clientDiagnostics, pipeline, subscriptionId, host);
        ...
        internal Operation<Response> CreateDelete(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Delete, "ExpressRouteCircuitConnectionsClient.Delete", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<ExpressRouteCircuitConnection> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Put, "ExpressRouteCircuitConnectionsClient.CreateOrUpdate", OperationFinalStateVia.AzureAsyncOperation, createOriginalHttpMessage,
