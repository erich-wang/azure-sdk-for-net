...
namespace Azure.Management.Network
{
    public partial class ApplicationGatewaysClient
    {
        ...
        internal ApplicationGatewaysClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new ApplicationGatewaysRestClient(clientDiagnostics, pipeline, subscriptionId, host);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ApplicationGateway>> UpdateTagsAsync(string resourceGroupName, string applicationGatewayName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ApplicationGateway> UpdateTags(string resourceGroupName, string applicationGatewayName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        internal Operation<Response> CreateDelete(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Delete, "ApplicationGatewaysClient.Delete", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<ApplicationGateway> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Put, "ApplicationGatewaysClient.CreateOrUpdate", OperationFinalStateVia.AzureAsyncOperation, createOriginalHttpMessage,
        ...
        internal Operation<Response> CreateStart(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "ApplicationGatewaysClient.Start", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<Response> CreateStop(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "ApplicationGatewaysClient.Stop", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<ApplicationGatewayBackendHealth> CreateBackendHealth(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "ApplicationGatewaysClient.BackendHealth", OperationFinalStateVia.Location, createOriginalHttpMessage,
            (response, cancellationToken) =>
            {
                using var document = JsonDocument.Parse(response.ContentStream);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<Operation<ApplicationGatewayBackendHealth>> StartBackendHealthAsync(string resourceGroupName, string applicationGatewayName, string expand, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="expand"> Expands BackendAddressPool and BackendHttpSettings referenced in backend health. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Operation<ApplicationGatewayBackendHealth> StartBackendHealth(string resourceGroupName, string applicationGatewayName, string expand, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal Operation<ApplicationGatewayBackendHealthOnDemand> CreateBackendHealthOnDemand(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "ApplicationGatewaysClient.BackendHealthOnDemand", OperationFinalStateVia.Location, createOriginalHttpMessage,
            (response, cancellationToken) =>
            {
                using var document = JsonDocument.Parse(response.ContentStream);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<Operation<ApplicationGatewayBackendHealthOnDemand>> StartBackendHealthOnDemandAsync(string resourceGroupName, string applicationGatewayName, string expand, ApplicationGatewayOnDemandProbe probeRequest, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            var originalResponse = await RestClient.BackendHealthOnDemandAsync(resourceGroupName, applicationGatewayName, expand, probeRequest, cancellationToken).ConfigureAwait(false);
            return CreateBackendHealthOnDemand(originalResponse, () => RestClient.CreateBackendHealthOnDemandRequest(resourceGroupName, applicationGatewayName, expand, probeRequest));
        }
        ...
        /// <param name="probeRequest"> Request body for on-demand test probe operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Operation<ApplicationGatewayBackendHealthOnDemand> StartBackendHealthOnDemand(string resourceGroupName, string applicationGatewayName, string expand, ApplicationGatewayOnDemandProbe probeRequest, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            var originalResponse = RestClient.BackendHealthOnDemand(resourceGroupName, applicationGatewayName, expand, probeRequest, cancellationToken);
            return CreateBackendHealthOnDemand(originalResponse, () => RestClient.CreateBackendHealthOnDemandRequest(resourceGroupName, applicationGatewayName, expand, probeRequest));
        }
    }
}
