...
namespace Azure.Management.Network
{
    public partial class ExpressRouteLinksClient
    {
        ...
        internal ExpressRouteLinksClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new ExpressRouteLinksRestClient(clientDiagnostics, pipeline, subscriptionId, host);
