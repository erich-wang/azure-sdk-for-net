...
namespace Azure.Management.Network
{
    ...
    public partial class LoadBalancerLoadBalancingRulesClient
    {
        ...
        public LoadBalancerLoadBalancingRulesClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new LoadBalancerLoadBalancingRulesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
