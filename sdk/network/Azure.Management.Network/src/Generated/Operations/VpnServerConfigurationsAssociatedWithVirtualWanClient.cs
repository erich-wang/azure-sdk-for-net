...
namespace Azure.Management.Network
{
    public partial class VpnServerConfigurationsAssociatedWithVirtualWanClient
    {
        ...
        internal VpnServerConfigurationsAssociatedWithVirtualWanClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new VpnServerConfigurationsAssociatedWithVirtualWanRestClient(clientDiagnostics, pipeline, subscriptionId, host);
        ...
        internal Operation<VpnServerConfigurationsResponse> CreateList(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "VpnServerConfigurationsAssociatedWithVirtualWanClient.List", OperationFinalStateVia.Location, createOriginalHttpMessage,
