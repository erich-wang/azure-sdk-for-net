...
namespace Azure.Management.Network
{
    public partial class ExpressRouteCrossConnectionsClient
    {
        ...
        internal ExpressRouteCrossConnectionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new ExpressRouteCrossConnectionsRestClient(clientDiagnostics, pipeline, subscriptionId, host);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ExpressRouteCrossConnection>> UpdateTagsAsync(string resourceGroupName, string crossConnectionName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ExpressRouteCrossConnection> UpdateTags(string resourceGroupName, string crossConnectionName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        internal Operation<ExpressRouteCrossConnection> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Put, "ExpressRouteCrossConnectionsClient.CreateOrUpdate", OperationFinalStateVia.AzureAsyncOperation, createOriginalHttpMessage,
        ...
        internal Operation<ExpressRouteCircuitsArpTableListResult> CreateListArpTable(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "ExpressRouteCrossConnectionsClient.ListArpTable", OperationFinalStateVia.Location, createOriginalHttpMessage,
            (response, cancellationToken) =>
            {
                using var document = JsonDocument.Parse(response.ContentStream);
        ...
        internal Operation<ExpressRouteCrossConnectionsRoutesTableSummaryListResult> CreateListRoutesTableSummary(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "ExpressRouteCrossConnectionsClient.ListRoutesTableSummary", OperationFinalStateVia.Location, createOriginalHttpMessage,
            (response, cancellationToken) =>
            {
                using var document = JsonDocument.Parse(response.ContentStream);
        ...
        internal Operation<ExpressRouteCircuitsRoutesTableListResult> CreateListRoutesTable(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "ExpressRouteCrossConnectionsClient.ListRoutesTable", OperationFinalStateVia.Location, createOriginalHttpMessage,
            (response, cancellationToken) =>
            {
                using var document = JsonDocument.Parse(response.ContentStream);
