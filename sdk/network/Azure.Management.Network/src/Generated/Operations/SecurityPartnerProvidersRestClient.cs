...
namespace Azure.Management.Network
{
    internal partial class SecurityPartnerProvidersRestClient
    {
        ...
        public async ValueTask<Response> DeleteAsync(string resourceGroupName, string securityPartnerProviderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProvidersClient.Delete");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response> CreateOrUpdateAsync(string resourceGroupName, string securityPartnerProviderName, SecurityPartnerProvider parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProvidersClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateUpdateTagsRequest(string resourceGroupName, string securityPartnerProviderName, IDictionary<string, string> tags)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<SecurityPartnerProvider>> UpdateTagsAsync(string resourceGroupName, string securityPartnerProviderName, IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                using var message = CreateUpdateTagsRequest(resourceGroupName, securityPartnerProviderName, tags);
                await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                switch (message.Response.Status)
                {
                    case 200:
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<SecurityPartnerProvider> UpdateTags(string resourceGroupName, string securityPartnerProviderName, IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
