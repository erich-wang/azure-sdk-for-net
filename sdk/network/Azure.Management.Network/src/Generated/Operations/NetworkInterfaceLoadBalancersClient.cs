...
namespace Azure.Management.Network
{
    ...
    public partial class NetworkInterfaceLoadBalancersClient
    {
        ...
        public NetworkInterfaceLoadBalancersClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new NetworkInterfaceLoadBalancersRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
