...
namespace Azure.Management.Network
{
    ...
    public partial class WebApplicationFirewallPoliciesClient
    {
        ...
        public WebApplicationFirewallPoliciesClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new WebApplicationFirewallPoliciesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
        ...
        internal Operation<Response> CreateDelete(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(_pipeline, _clientDiagnostics, originalResponse, RequestMethod.Delete, "WebApplicationFirewallPoliciesClient.Delete", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
