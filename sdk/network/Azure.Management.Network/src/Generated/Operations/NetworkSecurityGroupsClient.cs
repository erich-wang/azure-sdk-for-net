...
namespace Azure.Management.Network
{
    public partial class NetworkSecurityGroupsClient
    {
        ...
        internal NetworkSecurityGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new NetworkSecurityGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, host);
        ...
        public virtual async Task<Response<NetworkSecurityGroup>> GetAsync(string resourceGroupName, string networkSecurityGroupName, string expand, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> Expands BackendAddressPool and BackendHttpSettings referenced in backend health. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<NetworkSecurityGroup> Get(string resourceGroupName, string networkSecurityGroupName, string expand, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<NetworkSecurityGroup>> UpdateTagsAsync(string resourceGroupName, string networkSecurityGroupName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<NetworkSecurityGroup> UpdateTags(string resourceGroupName, string networkSecurityGroupName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        internal Operation<Response> CreateDelete(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Delete, "NetworkSecurityGroupsClient.Delete", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<NetworkSecurityGroup> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Put, "NetworkSecurityGroupsClient.CreateOrUpdate", OperationFinalStateVia.AzureAsyncOperation, createOriginalHttpMessage,
