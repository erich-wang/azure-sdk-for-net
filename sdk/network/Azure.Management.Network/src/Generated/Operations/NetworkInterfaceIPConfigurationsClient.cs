...
namespace Azure.Management.Network
{
    ...
    public partial class NetworkInterfaceIPConfigurationsClient
    {
        ...
        public NetworkInterfaceIPConfigurationsClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new NetworkInterfaceIPConfigurationsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
