...
namespace Azure.Management.Network
{
    internal partial class DdosCustomPoliciesRestClient
    {
        ...
        public async ValueTask<Response> DeleteAsync(string resourceGroupName, string ddosCustomPolicyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("DdosCustomPoliciesClient.Delete");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<DdosCustomPolicy>> GetAsync(string resourceGroupName, string ddosCustomPolicyName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("DdosCustomPoliciesClient.Get");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response> CreateOrUpdateAsync(string resourceGroupName, string ddosCustomPolicyName, DdosCustomPolicy parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("DdosCustomPoliciesClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<DdosCustomPolicy>> UpdateTagsAsync(string resourceGroupName, string ddosCustomPolicyName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = clientDiagnostics.CreateScope("DdosCustomPoliciesClient.UpdateTags");
            scope.Start();
            try
            {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<DdosCustomPolicy> UpdateTags(string resourceGroupName, string ddosCustomPolicyName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
