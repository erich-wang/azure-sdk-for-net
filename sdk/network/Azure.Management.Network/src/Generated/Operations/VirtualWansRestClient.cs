...
{
    internal partial class VirtualWansRestClient
    {
        ...
        /// <summary> Initializes a new instance of VirtualWansRestClient. </summary>
        public VirtualWansRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
        ...
        public async ValueTask<Response<VirtualWAN>> GetAsync(string resourceGroupName, string virtualWANName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("VirtualWansClient.Get");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response> CreateOrUpdateAsync(string resourceGroupName, string virtualWANName, VirtualWAN wANParameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("VirtualWansClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateUpdateTagsRequest(string resourceGroupName, string virtualWANName, IDictionary<string, string> tags)
        {
            var message = pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<VirtualWAN>> UpdateTagsAsync(string resourceGroupName, string virtualWANName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = clientDiagnostics.CreateScope("VirtualWansClient.UpdateTags");
            scope.Start();
            try
            {
                using var message = CreateUpdateTagsRequest(resourceGroupName, virtualWANName, tags);
                await pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                switch (message.Response.Status)
                {
                    case 200:
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<VirtualWAN> UpdateTags(string resourceGroupName, string virtualWANName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        public async ValueTask<Response> DeleteAsync(string resourceGroupName, string virtualWANName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("VirtualWansClient.Delete");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<ListVirtualWANsResult>> ListByResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("VirtualWansClient.ListByResourceGroup");
            scope.Start();
            try
            {
        ...
        {
            using var scope = clientDiagnostics.CreateScope("VirtualWansClient.List");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<ListVirtualWANsResult>> ListByResourceGroupNextPageAsync(string nextLink, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
        ...
        /// <param name="nextLink"> The URL to the next page of results. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ListVirtualWANsResult> ListByResourceGroupNextPage(string nextLink, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
