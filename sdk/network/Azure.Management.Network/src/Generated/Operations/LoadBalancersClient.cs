...
namespace Azure.Management.Network
{
    public partial class LoadBalancersClient
    {
        ...
        internal LoadBalancersClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new LoadBalancersRestClient(clientDiagnostics, pipeline, subscriptionId, host);
        ...
        public virtual async Task<Response<LoadBalancer>> GetAsync(string resourceGroupName, string loadBalancerName, string expand, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> Expands BackendAddressPool and BackendHttpSettings referenced in backend health. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<LoadBalancer> Get(string resourceGroupName, string loadBalancerName, string expand, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<LoadBalancer>> UpdateTagsAsync(string resourceGroupName, string loadBalancerName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<LoadBalancer> UpdateTags(string resourceGroupName, string loadBalancerName, IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        internal Operation<Response> CreateDelete(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Delete, "LoadBalancersClient.Delete", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<LoadBalancer> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Put, "LoadBalancersClient.CreateOrUpdate", OperationFinalStateVia.AzureAsyncOperation, createOriginalHttpMessage,
