...
namespace Azure.Management.Network
{
    ...
    public partial class LoadBalancerOutboundRulesClient
    {
        ...
        public LoadBalancerOutboundRulesClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new LoadBalancerOutboundRulesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
