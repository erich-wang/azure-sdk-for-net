...
namespace Azure.Management.Network
{
    public partial class AvailableResourceGroupDelegationsClient
    {
        ...
        internal AvailableResourceGroupDelegationsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new AvailableResourceGroupDelegationsRestClient(clientDiagnostics, pipeline, subscriptionId, host);
