...
namespace Azure.Management.Network
{
    ...
    public partial class AvailableResourceGroupDelegationsClient
    {
        ...
        public AvailableResourceGroupDelegationsClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new AvailableResourceGroupDelegationsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
