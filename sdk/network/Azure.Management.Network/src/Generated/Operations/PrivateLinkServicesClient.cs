...
namespace Azure.Management.Network
{
    ...
    public partial class PrivateLinkServicesClient
    {
        ...
        public PrivateLinkServicesClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new PrivateLinkServicesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<PrivateLinkServiceVisibility>> CheckPrivateLinkServiceVisibilityAsync(string location, string privateLinkServiceAlias = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="privateLinkServiceAlias"> The alias of the private link service. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<PrivateLinkServiceVisibility> CheckPrivateLinkServiceVisibility(string location, string privateLinkServiceAlias = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="privateLinkServiceAlias"> The alias of the private link service. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<PrivateLinkServiceVisibility>> CheckPrivateLinkServiceVisibilityByResourceGroupAsync(string location, string resourceGroupName, string privateLinkServiceAlias = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="privateLinkServiceAlias"> The alias of the private link service. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<PrivateLinkServiceVisibility> CheckPrivateLinkServiceVisibilityByResourceGroup(string location, string resourceGroupName, string privateLinkServiceAlias = null, CancellationToken cancellationToken = default)
        {
        ...
        internal Operation<Response> CreateDelete(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(_pipeline, _clientDiagnostics, originalResponse, RequestMethod.Delete, "PrivateLinkServicesClient.Delete", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
        ...
        internal Operation<PrivateLinkService> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(_pipeline, _clientDiagnostics, originalResponse, RequestMethod.Put, "PrivateLinkServicesClient.CreateOrUpdate", OperationFinalStateVia.AzureAsyncOperation, createOriginalHttpMessage,
        ...
        internal Operation<Response> CreateDeletePrivateEndpointConnection(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(_pipeline, _clientDiagnostics, originalResponse, RequestMethod.Delete, "PrivateLinkServicesClient.DeletePrivateEndpointConnection", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
