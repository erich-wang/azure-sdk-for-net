...
namespace Azure.Management.Network
{
    ...
    public partial class ServiceAssociationLinksClient
    {
        ...
        public ServiceAssociationLinksClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, options);
            RestClient = new ServiceAssociationLinksRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId);
        }
