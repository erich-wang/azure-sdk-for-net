...
namespace Azure.Management.Network
{
    public partial class OperationsClient
    {
        ...
        internal OperationsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com")
        {
            RestClient = new OperationsRestClient(clientDiagnostics, pipeline, host);
