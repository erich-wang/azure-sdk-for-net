...
namespace Azure.Management.Network
{
    public partial class AvailablePrivateEndpointTypesClient
    {
        ...
        internal AvailablePrivateEndpointTypesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
            RestClient = new AvailablePrivateEndpointTypesRestClient(clientDiagnostics, pipeline, subscriptionId, host);
