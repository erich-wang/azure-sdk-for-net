...
namespace Azure.Graph.Rbac
{
    ...
    public partial class ObjectsClient
    {
        ...
        public ObjectsClient(string tenantID, TokenCredential tokenCredential, RbacManagementClientOptions options = null) : this(tenantID, "https://graph.windows.net", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of ObjectsClient. </summary>
        public ObjectsClient(string tenantID, string host, TokenCredential tokenCredential, RbacManagementClientOptions options = null)
        {
            options ??= new RbacManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new ObjectsRestClient(_clientDiagnostics, _pipeline, tenantID: tenantID, host: host);
        }
