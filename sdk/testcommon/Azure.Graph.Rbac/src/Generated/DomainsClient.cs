...
namespace Azure.Graph.Rbac
{
    ...
    public partial class DomainsClient
    {
        ...
        public DomainsClient(string tenantID, TokenCredential tokenCredential, RbacManagementClientOptions options = null) : this(tenantID, "https://graph.windows.net", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of DomainsClient. </summary>
        public DomainsClient(string tenantID, string host, TokenCredential tokenCredential, RbacManagementClientOptions options = null)
        {
            options ??= new RbacManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new DomainsRestClient(_clientDiagnostics, _pipeline, tenantID: tenantID, host: host);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DomainsClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Domain> ListAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("DomainsClient.List");
                scope.Start();
                try
                {
