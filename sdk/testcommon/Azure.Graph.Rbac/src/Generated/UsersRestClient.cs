...
namespace Azure.Graph.Rbac
{
    internal partial class UsersRestClient
    {
        ...
        public UsersRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, string host = "https://graph.windows.net", string apiVersion = "1.6")
        {
            if (tenantID == null)
            {
        ...
        internal HttpMessage CreateListRequest(string filter, string expand)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<UserListResult>> ListAsync(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateListRequest(filter, expand);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="expand"> The expand value for the operation result. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<UserListResult> List(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateListRequest(filter, expand);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        internal HttpMessage CreateGetMemberGroupsRequest(string objectId, bool securityEnabledOnly)
        {
            ...
            request.Uri = uri;
            request.Headers.Add("Content-Type", "application/json");
            var model = new UserGetMemberGroupsParameters(securityEnabledOnly);
            using var content = new Utf8JsonRequestContent();
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<UserGetMemberGroupsResult>> GetMemberGroupsAsync(string objectId, bool securityEnabledOnly, CancellationToken cancellationToken = default)
        {
            if (objectId == null)
            {
        ...
        /// <param name="securityEnabledOnly"> If true, only membership in security-enabled groups should be checked. Otherwise, membership in all groups should be checked. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<UserGetMemberGroupsResult> GetMemberGroups(string objectId, bool securityEnabledOnly, CancellationToken cancellationToken = default)
        {
            if (objectId == null)
            {
                throw new ArgumentNullException(nameof(objectId));
