...
namespace Azure.Graph.Rbac
{
    ...
    public partial class OAuth2PermissionGrantClient
    {
        ...
        public OAuth2PermissionGrantClient(string tenantID, TokenCredential tokenCredential, RbacManagementClientOptions options = null) : this(tenantID, "https://graph.windows.net", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of OAuth2PermissionGrantClient. </summary>
        public OAuth2PermissionGrantClient(string tenantID, string host, TokenCredential tokenCredential, RbacManagementClientOptions options = null)
        {
            options ??= new RbacManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new OAuth2PermissionGrantRestClient(_clientDiagnostics, _pipeline, tenantID: tenantID, host: host);
        }
