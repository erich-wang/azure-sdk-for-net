...
namespace Azure.Graph.Rbac
{
    internal partial class DomainsRestClient
    {
        ...
        public DomainsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string tenantID, string host = "https://graph.windows.net", string apiVersion = "1.6")
        {
            if (tenantID == null)
            {
