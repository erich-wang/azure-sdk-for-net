...
namespace Azure.Graph.Rbac
{
    ...
    public partial class UsersClient
    {
        ...
        public UsersClient(string tenantID, TokenCredential tokenCredential, RbacManagementClientOptions options = null) : this(tenantID, "https://graph.windows.net", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of UsersClient. </summary>
        public UsersClient(string tenantID, string host, TokenCredential tokenCredential, RbacManagementClientOptions options = null)
        {
            options ??= new RbacManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new UsersRestClient(_clientDiagnostics, _pipeline, tenantID: tenantID, host: host);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("UsersClient.Delete");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<User> ListAsync(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<User>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await RestClient.ListAsync(filter, expand, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="expand"> The expand value for the operation result. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<User> List(string filter = null, string expand = null, CancellationToken cancellationToken = default)
        {
            Page<User> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = RestClient.List(filter, expand, cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<User> ListNextAsync(string nextLink, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<User>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("UsersClient.ListNext");
                scope.Start();
                try
                {
                    var response = await RestClient.ListNextAsync(nextLink, cancellationToken).ConfigureAwait(false);
