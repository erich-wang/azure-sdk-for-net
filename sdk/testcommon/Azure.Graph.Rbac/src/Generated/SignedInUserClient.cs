...
namespace Azure.Graph.Rbac
{
    ...
    public partial class SignedInUserClient
    {
        ...
        public SignedInUserClient(string tenantID, TokenCredential tokenCredential, RbacManagementClientOptions options = null) : this(tenantID, "https://graph.windows.net", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of SignedInUserClient. </summary>
        public SignedInUserClient(string tenantID, string host, TokenCredential tokenCredential, RbacManagementClientOptions options = null)
        {
            options ??= new RbacManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new SignedInUserRestClient(_clientDiagnostics, _pipeline, tenantID: tenantID, host: host);
        }
