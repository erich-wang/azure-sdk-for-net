...
namespace Azure.Management.Resource
{
    internal partial class ProvidersRestClient
    {
        ...
        public ProvidersRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2015-11-01")
        {
        ...
        internal HttpMessage CreateUnregisterRequest(string resourceProviderNamespace)
        {
        ...
        internal HttpMessage CreateRegisterRequest(string resourceProviderNamespace)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<ProviderListResult>> ListAsync(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="top"> Query parameters. If null is passed returns all deployments. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ProviderListResult> List(int? top = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProvidersClient.List");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetRequest(string resourceProviderNamespace)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="resourceProviderNamespace"> Namespace of the resource provider. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<Provider>> GetAsync(string resourceProviderNamespace, CancellationToken cancellationToken = default)
        {
            if (resourceProviderNamespace == null)
            {
                throw new ArgumentNullException(nameof(resourceProviderNamespace));
            ...
            try
            {
                using var message = CreateGetRequest(resourceProviderNamespace);
                await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                switch (message.Response.Status)
                {
                    case 200:
        ...
        /// <param name="top"> Query parameters. If null is passed returns all deployments. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<ProviderListResult>> ListNextPageAsync(string nextLink, int? top = null, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
        ...
        /// <param name="top"> Query parameters. If null is passed returns all deployments. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ProviderListResult> ListNextPage(string nextLink, int? top = null, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
