...
namespace Azure.Management.Resource
{
    ...
    public partial class ProvidersClient
    {
        ...
        public ProvidersClient(string subscriptionId, TokenCredential tokenCredential, ResourceManagementClientOptions options = null)
        {
            ...
            RestClient = new ProvidersRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, apiVersion: options.Version);
        }
        ...
        /// <param name="resourceProviderNamespace"> Namespace of the resource provider. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Provider>> GetAsync(string resourceProviderNamespace, CancellationToken cancellationToken = default)
        {
            return await RestClient.GetAsync(resourceProviderNamespace, cancellationToken).ConfigureAwait(false);
        }

        /// <summary> Gets a resource provider. </summary>
        /// <param name="resourceProviderNamespace"> Namespace of the resource provider. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Provider> Get(string resourceProviderNamespace, CancellationToken cancellationToken = default)
        {
            return RestClient.Get(resourceProviderNamespace, cancellationToken);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<Provider> ListAsync(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="top"> Query parameters. If null is passed returns all deployments. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<Provider> List(int? top = null, CancellationToken cancellationToken = default)
        {
