...
namespace Azure.Management.Resource
{
    internal partial class SubscriptionsRestClient
    {
        ...
        public SubscriptionsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com", string apiVersion = "2015-11-01")
        {
            if (host == null)
            {
        ...
        internal HttpMessage CreateListLocationsRequest(string subscriptionId)
        {
        ...
        public async ValueTask<Response<LocationListResult>> ListLocationsAsync(string subscriptionId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubscriptionsClient.ListLocations");
            scope.Start();
            try
            {
        ...
        public async ValueTask<Response<Subscription>> GetAsync(string subscriptionId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubscriptionsClient.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubscriptionsClient.List");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateListLocationsNextPageRequest(string nextLink, string subscriptionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="subscriptionId"> Id of the subscription. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<LocationListResult>> ListLocationsNextPageAsync(string nextLink, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
            ...
            try
            {
                using var message = CreateListLocationsNextPageRequest(nextLink, subscriptionId);
                await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                switch (message.Response.Status)
                {
                    case 200:
        ...
        /// <param name="subscriptionId"> Id of the subscription. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<LocationListResult> ListLocationsNextPage(string nextLink, string subscriptionId, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
