...
namespace Azure.Management.Resource
{
    ...
    public class ResourceManagementClient
    {
        ...
        /// <summary> Creates a new instance of ResourceProviderOperationDetailsClient. </summary>
        public ResourceProviderOperationDetailsClient GetResourceProviderOperationDetailsClient()
        {
            return new ResourceProviderOperationDetailsClient(_tokenCredential, _options);
        }

        /// <summary> Creates a new instance of PolicyDefinitionsClient. </summary>
        public PolicyDefinitionsClient GetPolicyDefinitionsClient()
        {
            return new PolicyDefinitionsClient(_subscriptionId, _tokenCredential, _options);
        }

        /// <summary> Creates a new instance of PolicyAssignmentsClient. </summary>
        public PolicyAssignmentsClient GetPolicyAssignmentsClient()
        {
            return new PolicyAssignmentsClient(_subscriptionId, _tokenCredential, _options);
        }

        /// <summary> Creates a new instance of SubscriptionsClient. </summary>
        public SubscriptionsClient GetSubscriptionsClient()
        {
            return new SubscriptionsClient(_tokenCredential, _options);
        }

        /// <summary> Creates a new instance of TenantsClient. </summary>
        public TenantsClient GetTenantsClient()
        {
            return new TenantsClient(_tokenCredential, _options);
        }
    }
}
