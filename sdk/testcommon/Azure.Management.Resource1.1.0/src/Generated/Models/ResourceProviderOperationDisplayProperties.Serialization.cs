...
namespace Azure.Management.Resource.Models
{
    ...
    {
        internal static ResourceProviderOperationDisplayProperties DeserializeResourceProviderOperationDisplayProperties(JsonElement element)
        {
            ...
            return new ResourceProviderOperationDisplayProperties(publisher, provider, resource, operation, description);
        }
    }
}
