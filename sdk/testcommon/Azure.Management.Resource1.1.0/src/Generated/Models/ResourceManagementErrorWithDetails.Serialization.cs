...
namespace Azure.Management.Resource.Models
{
    public partial class ResourceManagementErrorWithDetails
    {
        ...
        {
            IReadOnlyList<ResourceManagementError> details = default;
            string code = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("details"))
                {
                    ...
                    List<ResourceManagementError> array = new List<ResourceManagementError>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        ...
                        {
                            array.Add(DeserializeResourceManagementError(item));
                        }
                    }
                    details = array;
                    continue;
