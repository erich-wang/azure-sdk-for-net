    ...
    public partial class GenericResourceExpanded : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (CreatedTime != null)
            {
                ...
                writer.WriteStringValue(CreatedTime.Value, "S");
            }
            if (ChangedTime != null)
            {
                writer.WritePropertyName("changedTime");
                writer.WriteStringValue(ChangedTime.Value, "S");
            }
        ...
        internal static GenericResourceExpanded DeserializeGenericResourceExpanded(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("changedTime"))
                {
                    ...
                    changedTime = property.Value.GetDateTimeOffset("S");
                    continue;
                }
            ...
            return new GenericResourceExpanded(id, name, type, location, tags, plan, properties, createdTime, changedTime, provisioningState);
        }
    }
}
