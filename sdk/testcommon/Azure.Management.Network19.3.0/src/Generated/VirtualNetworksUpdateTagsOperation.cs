...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualNetworksUpdateTagsOperation : Operation<VirtualNetwork>, IOperationSource<VirtualNetwork>
    {
        private readonly ArmOperationHelpers<VirtualNetwork> _operation;
        internal VirtualNetworksUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<VirtualNetwork>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworksUpdateTagsOperation");
        }
        /// <inheritdoc />
