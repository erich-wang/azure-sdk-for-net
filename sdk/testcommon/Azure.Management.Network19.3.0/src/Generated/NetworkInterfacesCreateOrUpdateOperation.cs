...
namespace Azure.Management.Network
{
    ...
    public partial class NetworkInterfacesCreateOrUpdateOperation : Operation<NetworkInterface>, IOperationSource<NetworkInterface>
    {
        ...
        {
            _operation = new ArmOperationHelpers<NetworkInterface>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkInterfacesCreateOrUpdateOperation");
        }
        /// <inheritdoc />
