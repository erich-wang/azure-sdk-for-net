...
namespace Azure.Management.Network
{
    ...
    public partial class PublicIPPrefixesUpdateTagsOperation : Operation<PublicIPPrefix>, IOperationSource<PublicIPPrefix>
    {
        private readonly ArmOperationHelpers<PublicIPPrefix> _operation;
        internal PublicIPPrefixesUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<PublicIPPrefix>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PublicIPPrefixesUpdateTagsOperation");
        }
        /// <inheritdoc />
