...
namespace Azure.Management.Network
{
    ...
    public partial class RoutesCreateOrUpdateOperation : Operation<Route>, IOperationSource<Route>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Route>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RoutesCreateOrUpdateOperation");
        }
        /// <inheritdoc />
