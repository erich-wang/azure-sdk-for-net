...
namespace Azure.Management.Network
{
    ...
    public partial class InboundNatRulesCreateOrUpdateOperation : Operation<InboundNatRule>, IOperationSource<InboundNatRule>
    {
        ...
        {
            _operation = new ArmOperationHelpers<InboundNatRule>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "InboundNatRulesCreateOrUpdateOperation");
        }
        /// <inheritdoc />
