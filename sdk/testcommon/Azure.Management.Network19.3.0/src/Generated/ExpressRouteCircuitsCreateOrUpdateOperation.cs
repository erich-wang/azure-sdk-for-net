...
namespace Azure.Management.Network
{
    ...
    public partial class ExpressRouteCircuitsCreateOrUpdateOperation : Operation<ExpressRouteCircuit>, IOperationSource<ExpressRouteCircuit>
    {
        ...
        {
            _operation = new ArmOperationHelpers<ExpressRouteCircuit>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
