...
namespace Azure.Management.Network
{
    ...
    public partial class ServiceEndpointPoliciesCreateOrUpdateOperation : Operation<ServiceEndpointPolicy>, IOperationSource<ServiceEndpointPolicy>
    {
        ...
        {
            _operation = new ArmOperationHelpers<ServiceEndpointPolicy>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServiceEndpointPoliciesCreateOrUpdateOperation");
        }
        /// <inheritdoc />
