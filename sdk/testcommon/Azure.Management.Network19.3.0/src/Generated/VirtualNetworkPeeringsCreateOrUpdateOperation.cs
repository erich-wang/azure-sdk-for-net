...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualNetworkPeeringsCreateOrUpdateOperation : Operation<VirtualNetworkPeering>, IOperationSource<VirtualNetworkPeering>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualNetworkPeering>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkPeeringsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
