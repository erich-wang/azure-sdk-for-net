...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualNetworksCreateOrUpdateOperation : Operation<VirtualNetwork>, IOperationSource<VirtualNetwork>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualNetwork>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworksCreateOrUpdateOperation");
        }
        /// <inheritdoc />
