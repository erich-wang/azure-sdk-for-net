...
namespace Azure.Management.Network
{
    ...
    public partial class RouteFiltersClient
    {
        ...
        /// <summary> Updates a route filter in a specified resource group. </summary>
        /// <param name="resourceGroupName"> The name of the resource group. </param>
        /// <param name="routeFilterName"> The name of the route filter. </param>
        /// <param name="routeFilterParameters"> Parameters supplied to the update route filter operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<RouteFiltersUpdateOperation> StartUpdateAsync(string resourceGroupName, string routeFilterName, PatchRouteFilter routeFilterParameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("RouteFiltersClient.StartUpdate");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.UpdateAsync(resourceGroupName, routeFilterName, routeFilterParameters, cancellationToken).ConfigureAwait(false);
                return new RouteFiltersUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, routeFilterName, routeFilterParameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="routeFilterParameters"> Parameters supplied to the update route filter operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual RouteFiltersUpdateOperation StartUpdate(string resourceGroupName, string routeFilterName, PatchRouteFilter routeFilterParameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.Update(resourceGroupName, routeFilterName, routeFilterParameters, cancellationToken);
                return new RouteFiltersUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, routeFilterName, routeFilterParameters).Request, originalResponse);
            }
            catch (Exception e)
            {
