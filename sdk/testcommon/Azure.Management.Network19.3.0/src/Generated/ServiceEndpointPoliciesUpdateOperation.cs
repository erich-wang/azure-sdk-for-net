...
namespace Azure.Management.Network
{
    ...
    public partial class ServiceEndpointPoliciesUpdateOperation : Operation<ServiceEndpointPolicy>, IOperationSource<ServiceEndpointPolicy>
    {
        private readonly ArmOperationHelpers<ServiceEndpointPolicy> _operation;
        internal ServiceEndpointPoliciesUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ServiceEndpointPolicy>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServiceEndpointPoliciesUpdateOperation");
        }
        /// <inheritdoc />
