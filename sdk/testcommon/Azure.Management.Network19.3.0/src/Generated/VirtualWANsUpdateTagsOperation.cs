...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualWANsUpdateTagsOperation : Operation<VirtualWAN>, IOperationSource<VirtualWAN>
    {
        private readonly ArmOperationHelpers<VirtualWAN> _operation;
        internal VirtualWANsUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<VirtualWAN>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWANsUpdateTagsOperation");
        }
        /// <inheritdoc />
