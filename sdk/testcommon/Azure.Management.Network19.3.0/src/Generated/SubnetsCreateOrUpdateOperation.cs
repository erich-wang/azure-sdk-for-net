...
namespace Azure.Management.Network
{
    ...
    public partial class SubnetsCreateOrUpdateOperation : Operation<Subnet>, IOperationSource<Subnet>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Subnet>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SubnetsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
