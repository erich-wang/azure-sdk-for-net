...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionsUpdateTagsOperation : Operation<VirtualNetworkGatewayConnection>, IOperationSource<VirtualNetworkGatewayConnection>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualNetworkGatewayConnection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayConnectionsUpdateTagsOperation");
        }
        /// <inheritdoc />
