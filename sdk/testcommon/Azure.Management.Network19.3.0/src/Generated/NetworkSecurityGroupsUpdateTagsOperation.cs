...
namespace Azure.Management.Network
{
    ...
    public partial class NetworkSecurityGroupsUpdateTagsOperation : Operation<NetworkSecurityGroup>, IOperationSource<NetworkSecurityGroup>
    {
        private readonly ArmOperationHelpers<NetworkSecurityGroup> _operation;
        internal NetworkSecurityGroupsUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<NetworkSecurityGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkSecurityGroupsUpdateTagsOperation");
        }
        /// <inheritdoc />
