...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualNetworkGatewaysCreateOrUpdateOperation : Operation<VirtualNetworkGateway>, IOperationSource<VirtualNetworkGateway>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualNetworkGateway>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewaysCreateOrUpdateOperation");
        }
        /// <inheritdoc />
