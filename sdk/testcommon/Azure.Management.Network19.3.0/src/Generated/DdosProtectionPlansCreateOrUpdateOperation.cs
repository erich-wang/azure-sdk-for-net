...
namespace Azure.Management.Network
{
    ...
    public partial class DdosProtectionPlansCreateOrUpdateOperation : Operation<DdosProtectionPlan>, IOperationSource<DdosProtectionPlan>
    {
        ...
        {
            _operation = new ArmOperationHelpers<DdosProtectionPlan>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DdosProtectionPlansCreateOrUpdateOperation");
        }
        /// <inheritdoc />
