...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionsSetSharedKeyOperation : Operation<ConnectionSharedKey>, IOperationSource<ConnectionSharedKey>
    {
        ...
        {
            _operation = new ArmOperationHelpers<ConnectionSharedKey>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayConnectionsSetSharedKeyOperation");
        }
        /// <inheritdoc />
