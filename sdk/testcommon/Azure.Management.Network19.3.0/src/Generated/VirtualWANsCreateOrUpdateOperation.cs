...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualWANsCreateOrUpdateOperation : Operation<VirtualWAN>, IOperationSource<VirtualWAN>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualWAN>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualWANsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
