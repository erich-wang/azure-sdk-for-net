...
namespace Azure.Management.Network
{
    ...
    public partial class ServiceEndpointPoliciesClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<ServiceEndpointPoliciesUpdateOperation> StartUpdateAsync(string resourceGroupName, string serviceEndpointPolicyName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("ServiceEndpointPoliciesClient.StartUpdate");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.UpdateAsync(resourceGroupName, serviceEndpointPolicyName, parameters, cancellationToken).ConfigureAwait(false);
                return new ServiceEndpointPoliciesUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, serviceEndpointPolicyName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> Parameters supplied to update service endpoint policy tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ServiceEndpointPoliciesUpdateOperation StartUpdate(string resourceGroupName, string serviceEndpointPolicyName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.Update(resourceGroupName, serviceEndpointPolicyName, parameters, cancellationToken);
                return new ServiceEndpointPoliciesUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, serviceEndpointPolicyName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
