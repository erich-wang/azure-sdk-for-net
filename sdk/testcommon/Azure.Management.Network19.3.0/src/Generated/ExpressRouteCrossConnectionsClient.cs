...
namespace Azure.Management.Network
{
    ...
    public partial class ExpressRouteCrossConnectionsClient
    {
        ...
        public virtual async ValueTask<ExpressRouteCrossConnectionsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string crossConnectionName, ExpressRouteCrossConnection parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionsClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<ExpressRouteCrossConnectionsUpdateTagsOperation> StartUpdateTagsAsync(string resourceGroupName, string crossConnectionName, TagsObject crossConnectionParameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionsClient.StartUpdateTags");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.UpdateTagsAsync(resourceGroupName, crossConnectionName, crossConnectionParameters, cancellationToken).ConfigureAwait(false);
                return new ExpressRouteCrossConnectionsUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, crossConnectionName, crossConnectionParameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="crossConnectionParameters"> Parameters supplied to update express route cross connection tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ExpressRouteCrossConnectionsUpdateTagsOperation StartUpdateTags(string resourceGroupName, string crossConnectionName, TagsObject crossConnectionParameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.UpdateTags(resourceGroupName, crossConnectionName, crossConnectionParameters, cancellationToken);
                return new ExpressRouteCrossConnectionsUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, crossConnectionName, crossConnectionParameters).Request, originalResponse);
            }
            catch (Exception e)
            {
        ...
        public virtual async ValueTask<ExpressRouteCrossConnectionsListArpTableOperation> StartListArpTableAsync(string resourceGroupName, string crossConnectionName, string peeringName, string devicePath, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionsClient.StartListArpTable");
            scope.Start();
            try
            {
        ...
        public virtual async ValueTask<ExpressRouteCrossConnectionsListRoutesTableSummaryOperation> StartListRoutesTableSummaryAsync(string resourceGroupName, string crossConnectionName, string peeringName, string devicePath, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionsClient.StartListRoutesTableSummary");
            scope.Start();
            try
            {
        ...
        public virtual async ValueTask<ExpressRouteCrossConnectionsListRoutesTableOperation> StartListRoutesTableAsync(string resourceGroupName, string crossConnectionName, string peeringName, string devicePath, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionsClient.StartListRoutesTable");
            scope.Start();
            try
            {
