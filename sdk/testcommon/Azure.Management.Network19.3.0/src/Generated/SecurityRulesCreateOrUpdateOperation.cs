...
namespace Azure.Management.Network
{
    ...
    public partial class SecurityRulesCreateOrUpdateOperation : Operation<SecurityRule>, IOperationSource<SecurityRule>
    {
        ...
        {
            _operation = new ArmOperationHelpers<SecurityRule>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SecurityRulesCreateOrUpdateOperation");
        }
        /// <inheritdoc />
