...
namespace Azure.Management.Network
{
    ...
    public partial class RouteFiltersUpdateOperation : Operation<RouteFilter>, IOperationSource<RouteFilter>
    {
        private readonly ArmOperationHelpers<RouteFilter> _operation;
        internal RouteFiltersUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<RouteFilter>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RouteFiltersUpdateOperation");
        }
        /// <inheritdoc />
