...
namespace Azure.Management.Network
{
    ...
    public partial class RouteFilterRulesUpdateOperation : Operation<RouteFilterRule>, IOperationSource<RouteFilterRule>
    {
        private readonly ArmOperationHelpers<RouteFilterRule> _operation;
        internal RouteFilterRulesUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<RouteFilterRule>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RouteFilterRulesUpdateOperation");
        }
        /// <inheritdoc />
