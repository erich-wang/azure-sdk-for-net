...
{
    public partial class TrafficQuery : IUtf8JsonSerializable
    {
        ...
        internal static TrafficQuery DeserializeTrafficQuery(JsonElement element)
        {
            ...
            return new TrafficQuery(direction, protocol, source, destination, destinationPort);
        }
    }
}
