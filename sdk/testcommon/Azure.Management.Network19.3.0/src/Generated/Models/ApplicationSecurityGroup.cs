...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationSecurityGroup : Resource
    {
        ...
        /// <param name="provisioningState"> The provisioning state of the application security group resource. Possible values are: &apos;Succeeded&apos;, &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        internal ApplicationSecurityGroup(string id, string name, string type, string location, IDictionary<string, string> tags, string etag, string resourceGuid, string provisioningState) : base(id, name, type, location, tags)
        {
            Etag = etag;
        ...
        /// <summary> The provisioning state of the application security group resource. Possible values are: &apos;Succeeded&apos;, &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
