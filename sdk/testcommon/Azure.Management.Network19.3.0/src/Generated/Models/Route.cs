...
namespace Azure.Management.Network.Models
{
    ...
    public partial class Route : SubResource
    {
        ...
        internal Route(string id, string name, string etag, string addressPrefix, RouteNextHopType? nextHopType, string nextHopIpAddress, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
