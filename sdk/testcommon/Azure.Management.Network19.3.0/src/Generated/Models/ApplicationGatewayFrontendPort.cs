...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayFrontendPort : SubResource
    {
        ...
        /// <param name="provisioningState"> Provisioning state of the frontend port resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        internal ApplicationGatewayFrontendPort(string id, string name, string etag, string type, int? port, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
        ...
        /// <summary> Provisioning state of the frontend port resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
