...
namespace Azure.Management.Network.Models
{
    ...
    public partial class EffectiveNetworkSecurityRule
    {
        ...
        /// <param name="protocol"> The network protocol this rule applies to. Possible values are: &apos;Tcp&apos;, &apos;Udp&apos;, and &apos;All&apos;. </param>
        ...
        /// <param name="access"> Whether network traffic is allowed or denied. Possible values are: &apos;Allow&apos; and &apos;Deny&apos;. </param>
        /// <param name="priority"> The priority of the rule. </param>
        /// <param name="direction"> The direction of the rule. Possible values are: &apos;Inbound and Outbound&apos;. </param>
        ...
        /// <summary> The network protocol this rule applies to. Possible values are: &apos;Tcp&apos;, &apos;Udp&apos;, and &apos;All&apos;. </summary>
        ...
        /// <summary> Whether network traffic is allowed or denied. Possible values are: &apos;Allow&apos; and &apos;Deny&apos;. </summary>
        public SecurityRuleAccess? Access { get; }
        /// <summary> The priority of the rule. </summary>
        public int? Priority { get; }
        /// <summary> The direction of the rule. Possible values are: &apos;Inbound and Outbound&apos;. </summary>
