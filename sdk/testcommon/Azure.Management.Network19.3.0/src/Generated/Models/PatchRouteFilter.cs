...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PatchRouteFilter : SubResource
    {
        ...
        internal PatchRouteFilter(string id, string name, string etag, string type, IDictionary<string, string> tags, IList<RouteFilterRule> rules, IList<ExpressRouteCircuitPeering> peerings, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
