...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetwork : Resource
    {
        ...
        internal VirtualNetwork(string id, string name, string type, string location, IDictionary<string, string> tags, string etag, AddressSpace addressSpace, DhcpOptions dhcpOptions, IList<Subnet> subnets, IList<VirtualNetworkPeering> virtualNetworkPeerings, string resourceGuid, string provisioningState, bool? enableDdosProtection, bool? enableVmProtection, SubResource ddosProtectionPlan) : base(id, name, type, location, tags)
        {
            Etag = etag;
