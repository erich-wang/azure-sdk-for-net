...
namespace Azure.Management.Network.Models
{
    ...
    public partial class FlowLogInformation
    {
        ...
        internal FlowLogInformation(string targetResourceId, TrafficAnalyticsProperties flowAnalyticsConfiguration, string storageId, bool enabled, RetentionPolicyParameters retentionPolicy)
        {
            TargetResourceId = targetResourceId;
