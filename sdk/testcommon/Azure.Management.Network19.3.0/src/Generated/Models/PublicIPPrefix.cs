...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PublicIPPrefix : Resource
    {
        ...
        /// <param name="provisioningState"> The provisioning state of the Public IP prefix resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        internal PublicIPPrefix(string id, string name, string type, string location, IDictionary<string, string> tags, PublicIPPrefixSku sku, string etag, IList<string> zones, IPVersion? publicIPAddressVersion, IList<IpTag> ipTags, int? prefixLength, string ipPrefix, IList<ReferencedPublicIpAddress> publicIPAddresses, SubResource loadBalancerFrontendIpConfiguration, string resourceGuid, string provisioningState) : base(id, name, type, location, tags)
        {
            Sku = sku;
            Etag = etag;
            Zones = zones;
        ...
        /// <summary> The provisioning state of the Public IP prefix resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
