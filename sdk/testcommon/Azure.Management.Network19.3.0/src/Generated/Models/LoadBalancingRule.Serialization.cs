...
namespace Azure.Management.Network.Models
{
    public partial class LoadBalancingRule : IUtf8JsonSerializable
    {
        ...
        internal static LoadBalancingRule DeserializeLoadBalancingRule(JsonElement element)
        {
            ...
            return new LoadBalancingRule(id, name, etag, frontendIPConfiguration, backendAddressPool, probe, protocol, loadDistribution, frontendPort, backendPort, idleTimeoutInMinutes, enableFloatingIP, enableTcpReset, disableOutboundSnat, provisioningState);
        }
    }
}
