...
namespace Azure.Management.Network.Models
{
    ...
    public partial class SecurityRule : SubResource
    {
        ...
        /// <param name="protocol"> Network protocol this rule applies to. Possible values are &apos;Tcp&apos;, &apos;Udp&apos;, and &apos;*&apos;. </param>
        ...
        /// <param name="access"> The network traffic is allowed or denied. Possible values are: &apos;Allow&apos; and &apos;Deny&apos;. </param>
        ...
        /// <param name="direction"> The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are: &apos;Inbound&apos; and &apos;Outbound&apos;. </param>
        ...
        /// <summary> Network protocol this rule applies to. Possible values are &apos;Tcp&apos;, &apos;Udp&apos;, and &apos;*&apos;. </summary>
        ...
        /// <summary> The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are: &apos;Inbound&apos; and &apos;Outbound&apos;. </summary>
