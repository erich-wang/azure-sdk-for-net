...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VpnClientRootCertificate : SubResource
    {
        ...
        /// <param name="publicCertData"> The certificate public data. </param>
        /// <param name="provisioningState"> The provisioning state of the VPN client root certificate resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        internal VpnClientRootCertificate(string id, string name, string etag, string publicCertData, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            PublicCertData = publicCertData;
        ...
        /// <summary> The provisioning state of the VPN client root certificate resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
