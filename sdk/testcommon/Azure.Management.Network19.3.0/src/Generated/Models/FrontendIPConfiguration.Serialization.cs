...
namespace Azure.Management.Network.Models
{
    public partial class FrontendIPConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static FrontendIPConfiguration DeserializeFrontendIPConfiguration(JsonElement element)
        {
            ...
            return new FrontendIPConfiguration(id, name, etag, zones, inboundNatRules, inboundNatPools, outboundRules, loadBalancingRules, privateIPAddress, privateIPAllocationMethod, subnet, publicIPAddress, publicIPPrefix, provisioningState);
        }
    }
}
