...
namespace Azure.Management.Network.Models
{
    ...
    public partial class PatchRouteFilterRule : SubResource
    {
        ...
        internal PatchRouteFilterRule(string id, string name, string etag, Access? access, string routeFilterRuleType, IList<string> communities, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            Access = access;
