...
namespace Azure.Management.Network.Models
{
    public partial class OutboundRule : IUtf8JsonSerializable
    {
        ...
        internal static OutboundRule DeserializeOutboundRule(JsonElement element)
        {
            ...
            OutboundRulePropertiesFormatProtocol? protocol = default;
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("protocol"))
                        {
                            ...
                            protocol = new OutboundRulePropertiesFormatProtocol(property0.Value.GetString());
                            continue;
                        }
            ...
            return new OutboundRule(id, name, etag, allocatedOutboundPorts, frontendIPConfigurations, backendAddressPool, provisioningState, protocol, enableTcpReset, idleTimeoutInMinutes);
        }
    }
}
