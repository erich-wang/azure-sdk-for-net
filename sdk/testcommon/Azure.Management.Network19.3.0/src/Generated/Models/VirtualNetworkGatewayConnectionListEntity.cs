...
namespace Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayConnectionListEntity : Resource
    {
        ...
        /// <param name="connectionType"> Gateway connection type. Possible values are: &apos;IPsec&apos;,&apos;Vnet2Vnet&apos;,&apos;ExpressRoute&apos;, and &apos;VPNClient. </param>
        ...
        /// <param name="connectionStatus"> Virtual network Gateway connection status. Possible values are &apos;Unknown&apos;, &apos;Connecting&apos;, &apos;Connected&apos; and &apos;NotConnected&apos;. </param>
        ...
        /// <param name="resourceGuid"> The resource GUID property of the VirtualNetworkGatewayConnection resource. </param>
        /// <param name="provisioningState"> The provisioning state of the VirtualNetworkGatewayConnection resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        /// <param name="expressRouteGatewayBypass"> Bypass ExpressRoute Gateway for data forwarding. </param>
        internal VirtualNetworkGatewayConnectionListEntity(string id, string name, string type, string location, IDictionary<string, string> tags, string etag, string authorizationKey, VirtualNetworkConnectionGatewayReference virtualNetworkGateway1, VirtualNetworkConnectionGatewayReference virtualNetworkGateway2, VirtualNetworkConnectionGatewayReference localNetworkGateway2, VirtualNetworkGatewayConnectionType connectionType, int? routingWeight, string sharedKey, VirtualNetworkGatewayConnectionStatus? connectionStatus, IList<TunnelConnectionHealth> tunnelConnectionStatus, long? egressBytesTransferred, long? ingressBytesTransferred, SubResource peer, bool? enableBgp, bool? usePolicyBasedTrafficSelectors, IList<IpsecPolicy> ipsecPolicies, string resourceGuid, string provisioningState, bool? expressRouteGatewayBypass) : base(id, name, type, location, tags)
        {
            Etag = etag;
        ...
        /// <summary> Gateway connection type. Possible values are: &apos;IPsec&apos;,&apos;Vnet2Vnet&apos;,&apos;ExpressRoute&apos;, and &apos;VPNClient. </summary>
        ...
        /// <summary> Virtual network Gateway connection status. Possible values are &apos;Unknown&apos;, &apos;Connecting&apos;, &apos;Connected&apos; and &apos;NotConnected&apos;. </summary>
        ...
        /// <summary> The provisioning state of the VirtualNetworkGatewayConnection resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
