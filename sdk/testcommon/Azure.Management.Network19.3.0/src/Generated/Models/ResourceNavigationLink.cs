...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ResourceNavigationLink : SubResource
    {
        ...
        /// <param name="provisioningState"> Provisioning state of the ResourceNavigationLink resource. </param>
        internal ResourceNavigationLink(string id, string name, string etag, string linkedResourceType, string link, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
