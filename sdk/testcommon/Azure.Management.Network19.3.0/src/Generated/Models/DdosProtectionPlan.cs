...
namespace Azure.Management.Network.Models
{
    ...
    public partial class DdosProtectionPlan
    {
        ...
        /// <param name="provisioningState"> The provisioning state of the DDoS protection plan resource. Possible values are: &apos;Succeeded&apos;, &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        ...
        internal DdosProtectionPlan(string id, string name, string type, string location, IDictionary<string, string> tags, string etag, string resourceGuid, string provisioningState, IList<SubResource> virtualNetworks)
        {
            Id = id;
            Name = name;
            Type = type;
        ...
        /// <summary> The provisioning state of the DDoS protection plan resource. Possible values are: &apos;Succeeded&apos;, &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
