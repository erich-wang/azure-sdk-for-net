...
namespace Azure.Management.Network.Models
{
    public partial class PublicIPAddress : IUtf8JsonSerializable
    {
        ...
        internal static PublicIPAddress DeserializePublicIPAddress(JsonElement element)
        {
            ...
            return new PublicIPAddress(id, name, type, location, tags, sku, etag, zones, publicIPAllocationMethod, publicIPAddressVersion, ipConfiguration, dnsSettings, ipTags, ipAddress, publicIPPrefix, idleTimeoutInMinutes, resourceGuid, provisioningState);
        }
    }
}
