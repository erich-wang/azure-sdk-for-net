...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCircuit : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (AllowGlobalReach != null)
            {
                writer.WritePropertyName("allowGlobalReach");
                writer.WriteBooleanValue(AllowGlobalReach.Value);
            }
            writer.WriteEndObject();
            writer.WriteEndObject();
        }
        ...
        internal static ExpressRouteCircuit DeserializeExpressRouteCircuit(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("allowGlobalReach"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            allowGlobalReach = property0.Value.GetBoolean();
                            continue;
                        }
                    }
                    continue;
            ...
            return new ExpressRouteCircuit(id, name, type, location, tags, sku, etag, allowClassicOperations, circuitProvisioningState, serviceProviderProvisioningState, authorizations, peerings, serviceKey, serviceProviderNotes, serviceProviderProperties, provisioningState, gatewayManagerEtag, allowGlobalReach);
        }
    }
}
