...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ServiceEndpointPolicyDefinition : SubResource
    {
        ...
        /// <param name="provisioningState"> The provisioning state of the service end point policy definition. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        internal ServiceEndpointPolicyDefinition(string id, string name, string etag, string description, string service, IList<string> serviceResources, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
        ...
        /// <summary> The provisioning state of the service end point policy definition. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
