...
namespace Azure.Management.Network.Models
{
    public partial class ApplicationGatewayProbe : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewayProbe DeserializeApplicationGatewayProbe(JsonElement element)
        {
            ...
            return new ApplicationGatewayProbe(id, name, etag, type, protocol, host, path, interval, timeout, unhealthyThreshold, pickHostNameFromBackendHttpSettings, minServers, match, provisioningState);
        }
    }
}
