...
namespace Azure.Management.Network.Models
{
    ...
    public partial class InboundNatPool : SubResource
    {
        ...
        internal InboundNatPool(string id, string name, string etag, SubResource frontendIPConfiguration, TransportProtocol? protocol, int? frontendPortRangeStart, int? frontendPortRangeEnd, int? backendPort, int? idleTimeoutInMinutes, bool? enableFloatingIP, bool? enableTcpReset, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
