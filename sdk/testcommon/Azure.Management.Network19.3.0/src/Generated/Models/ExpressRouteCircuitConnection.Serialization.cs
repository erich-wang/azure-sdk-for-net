...
namespace Azure.Management.Network.Models
{
    public partial class ExpressRouteCircuitConnection : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteCircuitConnection DeserializeExpressRouteCircuitConnection(JsonElement element)
        {
            ...
            return new ExpressRouteCircuitConnection(id, name, etag, expressRouteCircuitPeering, peerExpressRouteCircuitPeering, addressPrefix, authorizationKey, circuitConnectionStatus, provisioningState);
        }
    }
}
