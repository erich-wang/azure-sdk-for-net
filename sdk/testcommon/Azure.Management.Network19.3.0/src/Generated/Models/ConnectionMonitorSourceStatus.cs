...
namespace Azure.Management.Network.Models
{
    ...
    public readonly partial struct ConnectionMonitorSourceStatus : IEquatable<ConnectionMonitorSourceStatus>
    {
        ...
        private const string UknownValue = "Uknown";
        private const string ActiveValue = "Active";
        private const string InactiveValue = "Inactive";

        /// <summary> Uknown. </summary>
        public static ConnectionMonitorSourceStatus Uknown { get; } = new ConnectionMonitorSourceStatus(UknownValue);
