...
namespace Azure.Management.Network.Models
{
    ...
    public partial class SecurityRuleAssociations
    {
        ...
        /// <summary> Initializes a new instance of SecurityRuleAssociations. </summary>
        /// <param name="networkInterfaceAssociation"> Network interface and its custom security rules. </param>
        /// <param name="subnetAssociation"> Network interface and its custom security rules. </param>
