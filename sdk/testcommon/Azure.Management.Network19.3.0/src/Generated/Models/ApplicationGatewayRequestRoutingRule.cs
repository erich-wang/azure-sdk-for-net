...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayRequestRoutingRule : SubResource
    {
        ...
        /// <param name="provisioningState"> Provisioning state of the request routing rule resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </param>
        internal ApplicationGatewayRequestRoutingRule(string id, string name, string etag, string type, ApplicationGatewayRequestRoutingRuleType? ruleType, SubResource backendAddressPool, SubResource backendHttpSettings, SubResource httpListener, SubResource urlPathMap, SubResource redirectConfiguration, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
        ...
        /// <summary> Provisioning state of the request routing rule resource. Possible values are: &apos;Updating&apos;, &apos;Deleting&apos;, and &apos;Failed&apos;. </summary>
