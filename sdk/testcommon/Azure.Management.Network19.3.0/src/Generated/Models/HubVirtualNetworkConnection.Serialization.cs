...
namespace Azure.Management.Network.Models
{
    public partial class HubVirtualNetworkConnection : IUtf8JsonSerializable
    {
        ...
        internal static HubVirtualNetworkConnection DeserializeHubVirtualNetworkConnection(JsonElement element)
        {
            ...
            return new HubVirtualNetworkConnection(id, name, type, location, tags, etag, remoteVirtualNetwork, allowHubToRemoteVnetTransit, allowRemoteVnetToUseHubVnetGateways, provisioningState);
        }
    }
}
