                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("routeFilter"))
                        {
                            ...
                            routeFilter = RouteFilter.DeserializeRouteFilter(property0.Value);
                            continue;
                        }
