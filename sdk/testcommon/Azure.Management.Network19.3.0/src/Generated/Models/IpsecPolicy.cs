...
namespace Azure.Management.Network.Models
{
    ...
    public partial class IpsecPolicy
    {
        ...
        /// <param name="dhGroup"> The DH Groups used in IKE Phase 1 for initial SA. </param>
        /// <param name="pfsGroup"> The Pfs Groups used in IKE Phase 2 for new child SA. </param>
