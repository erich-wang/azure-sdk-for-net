...
namespace Azure.Management.Network.Models
{
    ...
    public partial class Ipv6ExpressRouteCircuitPeeringConfig
    {
        ...
        /// <param name="state"> The state of peering. Possible values are: &apos;Disabled&apos; and &apos;Enabled&apos;. </param>
        internal Ipv6ExpressRouteCircuitPeeringConfig(string primaryPeerAddressPrefix, string secondaryPeerAddressPrefix, ExpressRouteCircuitPeeringConfig microsoftPeeringConfig, RouteFilter routeFilter, ExpressRouteCircuitPeeringState? state)
        {
