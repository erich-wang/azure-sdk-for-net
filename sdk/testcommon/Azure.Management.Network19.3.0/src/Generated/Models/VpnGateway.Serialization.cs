...
namespace Azure.Management.Network.Models
{
    public partial class VpnGateway : IUtf8JsonSerializable
    {
        ...
        internal static VpnGateway DeserializeVpnGateway(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("policies"))
                        {
                            ...
                            policies = Policies.DeserializePolicies(property0.Value);
                            continue;
                        }
                    }
                    continue;
            ...
            return new VpnGateway(id, name, type, location, tags, etag, virtualHub, connections, bgpSettings, provisioningState, policies);
        }
    }
}
