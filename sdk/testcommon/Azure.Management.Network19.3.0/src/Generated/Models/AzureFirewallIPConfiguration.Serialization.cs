...
namespace Azure.Management.Network.Models
{
    public partial class AzureFirewallIPConfiguration : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (InternalPublicIpAddress != null)
            {
                writer.WritePropertyName("internalPublicIpAddress");
                writer.WriteObjectValue(InternalPublicIpAddress);
            }
        ...
        internal static AzureFirewallIPConfiguration DeserializeAzureFirewallIPConfiguration(JsonElement element)
        {
            ...
            SubResource internalPublicIpAddress = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("internalPublicIpAddress"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            internalPublicIpAddress = DeserializeSubResource(property0.Value);
                            continue;
                        }
            ...
            return new AzureFirewallIPConfiguration(id, name, etag, privateIPAddress, subnet, internalPublicIpAddress, publicIPAddress, provisioningState);
        }
    }
}
