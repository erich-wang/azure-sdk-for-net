...
namespace Azure.Management.Network.Models
{
    public partial class ConnectionMonitorResult
    {
        internal static ConnectionMonitorResult DeserializeConnectionMonitorResult(JsonElement element)
        {
            ...
            return new ConnectionMonitorResult(name, id, etag, type, location, tags, source, destination, autoStart, monitoringIntervalInSeconds, provisioningState, startTime, monitoringStatus);
        }
    }
}
