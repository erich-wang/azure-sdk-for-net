...
namespace Azure.Management.Network.Models
{
    public partial class ApplicationGateway : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGateway DeserializeApplicationGateway(JsonElement element)
        {
            ...
            return new ApplicationGateway(id, name, type, location, tags, etag, zones, sku, sslPolicy, operationalState, gatewayIPConfigurations, authenticationCertificates, sslCertificates, frontendIPConfigurations, frontendPorts, probes, backendAddressPools, backendHttpSettingsCollection, httpListeners, urlPathMaps, requestRoutingRules, redirectConfigurations, webApplicationFirewallConfiguration, enableHttp2, enableFips, autoscaleConfiguration, resourceGuid, provisioningState);
        }
    }
}
