...
namespace Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayFirewallRuleSet : Resource
    {
        ...
        internal ApplicationGatewayFirewallRuleSet(string id, string name, string type, string location, IDictionary<string, string> tags, string provisioningState, string ruleSetType, string ruleSetVersion, IList<ApplicationGatewayFirewallRuleGroup> ruleGroups) : base(id, name, type, location, tags)
        {
