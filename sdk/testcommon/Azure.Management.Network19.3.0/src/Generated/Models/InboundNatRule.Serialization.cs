...
namespace Azure.Management.Network.Models
{
    public partial class InboundNatRule : IUtf8JsonSerializable
    {
        ...
        internal static InboundNatRule DeserializeInboundNatRule(JsonElement element)
        {
            ...
            return new InboundNatRule(id, name, etag, frontendIPConfiguration, backendIPConfiguration, protocol, frontendPort, backendPort, idleTimeoutInMinutes, enableFloatingIP, enableTcpReset, provisioningState);
        }
    }
}
