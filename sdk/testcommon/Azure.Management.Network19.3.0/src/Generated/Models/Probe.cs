...
namespace Azure.Management.Network.Models
{
    ...
    public partial class Probe : SubResource
    {
        ...
        /// <param name="protocol"> The protocol of the end point. Possible values are: &apos;Http&apos;, &apos;Tcp&apos;, or &apos;Https&apos;. If &apos;Tcp&apos; is specified, a received ACK is required for the probe to be successful. If &apos;Http&apos; or &apos;Https&apos; is specified, a 200 OK response from the specifies URI is required for the probe to be successful. </param>
        ...
        internal Probe(string id, string name, string etag, IList<SubResource> loadBalancingRules, ProbeProtocol? protocol, int? port, int? intervalInSeconds, int? numberOfProbes, string requestPath, string provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
        ...
        /// <summary> The protocol of the end point. Possible values are: &apos;Http&apos;, &apos;Tcp&apos;, or &apos;Https&apos;. If &apos;Tcp&apos; is specified, a received ACK is required for the probe to be successful. If &apos;Http&apos; or &apos;Https&apos; is specified, a 200 OK response from the specifies URI is required for the probe to be successful. </summary>
