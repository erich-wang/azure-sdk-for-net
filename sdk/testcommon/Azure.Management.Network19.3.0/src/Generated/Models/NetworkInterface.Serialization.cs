...
namespace Azure.Management.Network.Models
{
    public partial class NetworkInterface : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface DeserializeNetworkInterface(JsonElement element)
        {
            ...
            return new NetworkInterface(id, name, type, location, tags, etag, virtualMachine, networkSecurityGroup, ipConfigurations, dnsSettings, macAddress, primary, enableAcceleratedNetworking, enableIPForwarding, resourceGuid, provisioningState);
        }
    }
}
