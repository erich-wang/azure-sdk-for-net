...
namespace Azure.Management.Network
{
    ...
    public partial class PacketCapturesCreateOperation : Operation<PacketCaptureResult>, IOperationSource<PacketCaptureResult>
    {
        ...
        {
            _operation = new ArmOperationHelpers<PacketCaptureResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PacketCapturesCreateOperation");
        }
        /// <inheritdoc />
