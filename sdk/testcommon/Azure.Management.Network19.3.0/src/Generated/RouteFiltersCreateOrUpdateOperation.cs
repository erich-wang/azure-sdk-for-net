...
namespace Azure.Management.Network
{
    ...
    public partial class RouteFiltersCreateOrUpdateOperation : Operation<RouteFilter>, IOperationSource<RouteFilter>
    {
        ...
        {
            _operation = new ArmOperationHelpers<RouteFilter>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RouteFiltersCreateOrUpdateOperation");
        }
        /// <inheritdoc />
