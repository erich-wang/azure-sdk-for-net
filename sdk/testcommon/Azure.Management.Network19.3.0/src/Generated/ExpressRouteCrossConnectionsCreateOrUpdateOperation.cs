...
namespace Azure.Management.Network
{
    ...
    public partial class ExpressRouteCrossConnectionsCreateOrUpdateOperation : Operation<ExpressRouteCrossConnection>, IOperationSource<ExpressRouteCrossConnection>
    {
        ...
        {
            _operation = new ArmOperationHelpers<ExpressRouteCrossConnection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCrossConnectionsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
