...
namespace Azure.Management.Network
{
    ...
    public partial class PublicIPAddressesUpdateTagsOperation : Operation<PublicIPAddress>, IOperationSource<PublicIPAddress>
    {
        private readonly ArmOperationHelpers<PublicIPAddress> _operation;
        internal PublicIPAddressesUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<PublicIPAddress>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PublicIPAddressesUpdateTagsOperation");
        }
        /// <inheritdoc />
