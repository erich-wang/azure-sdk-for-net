...
namespace Azure.Management.Network
{
    ...
    public partial class RouteTablesCreateOrUpdateOperation : Operation<RouteTable>, IOperationSource<RouteTable>
    {
        ...
        {
            _operation = new ArmOperationHelpers<RouteTable>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RouteTablesCreateOrUpdateOperation");
        }
        /// <inheritdoc />
