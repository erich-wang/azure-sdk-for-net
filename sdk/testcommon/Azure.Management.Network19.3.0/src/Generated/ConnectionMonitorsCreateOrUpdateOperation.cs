...
namespace Azure.Management.Network
{
    ...
    public partial class ConnectionMonitorsCreateOrUpdateOperation : Operation<ConnectionMonitorResult>, IOperationSource<ConnectionMonitorResult>
    {
        ...
        {
            _operation = new ArmOperationHelpers<ConnectionMonitorResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ConnectionMonitorsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
