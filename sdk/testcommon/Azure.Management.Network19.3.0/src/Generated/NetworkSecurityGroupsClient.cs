...
namespace Azure.Management.Network
{
    ...
    public partial class NetworkSecurityGroupsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<NetworkSecurityGroupsUpdateTagsOperation> StartUpdateTagsAsync(string resourceGroupName, string networkSecurityGroupName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("NetworkSecurityGroupsClient.StartUpdateTags");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.UpdateTagsAsync(resourceGroupName, networkSecurityGroupName, parameters, cancellationToken).ConfigureAwait(false);
                return new NetworkSecurityGroupsUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, networkSecurityGroupName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> Parameters supplied to update network security group tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual NetworkSecurityGroupsUpdateTagsOperation StartUpdateTags(string resourceGroupName, string networkSecurityGroupName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.UpdateTags(resourceGroupName, networkSecurityGroupName, parameters, cancellationToken);
                return new NetworkSecurityGroupsUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, networkSecurityGroupName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
