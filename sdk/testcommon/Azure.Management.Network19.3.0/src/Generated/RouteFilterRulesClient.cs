...
namespace Azure.Management.Network
{
    ...
    public partial class RouteFilterRulesClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<RouteFilterRulesUpdateOperation> StartUpdateAsync(string resourceGroupName, string routeFilterName, string ruleName, PatchRouteFilterRule routeFilterRuleParameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("RouteFilterRulesClient.StartUpdate");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.UpdateAsync(resourceGroupName, routeFilterName, ruleName, routeFilterRuleParameters, cancellationToken).ConfigureAwait(false);
                return new RouteFilterRulesUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, routeFilterName, ruleName, routeFilterRuleParameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="routeFilterRuleParameters"> Parameters supplied to the update route filter rule operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual RouteFilterRulesUpdateOperation StartUpdate(string resourceGroupName, string routeFilterName, string ruleName, PatchRouteFilterRule routeFilterRuleParameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.Update(resourceGroupName, routeFilterName, ruleName, routeFilterRuleParameters, cancellationToken);
                return new RouteFilterRulesUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, routeFilterName, ruleName, routeFilterRuleParameters).Request, originalResponse);
            }
            catch (Exception e)
            {
