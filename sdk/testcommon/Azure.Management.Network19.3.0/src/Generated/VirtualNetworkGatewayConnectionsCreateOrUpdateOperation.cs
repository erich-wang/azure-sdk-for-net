...
namespace Azure.Management.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionsCreateOrUpdateOperation : Operation<VirtualNetworkGatewayConnection>, IOperationSource<VirtualNetworkGatewayConnection>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualNetworkGatewayConnection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualNetworkGatewayConnectionsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
