...
namespace Azure.Management.Network
{
    ...
    public partial class LoadBalancersUpdateTagsOperation : Operation<LoadBalancer>, IOperationSource<LoadBalancer>
    {
        private readonly ArmOperationHelpers<LoadBalancer> _operation;
        internal LoadBalancersUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<LoadBalancer>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LoadBalancersUpdateTagsOperation");
        }
        /// <inheritdoc />
