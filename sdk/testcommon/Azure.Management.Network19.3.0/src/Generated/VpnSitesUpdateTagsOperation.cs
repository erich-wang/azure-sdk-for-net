...
namespace Azure.Management.Network
{
    ...
    public partial class VpnSitesUpdateTagsOperation : Operation<VpnSite>, IOperationSource<VpnSite>
    {
        private readonly ArmOperationHelpers<VpnSite> _operation;
        internal VpnSitesUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<VpnSite>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VpnSitesUpdateTagsOperation");
        }
        /// <inheritdoc />
