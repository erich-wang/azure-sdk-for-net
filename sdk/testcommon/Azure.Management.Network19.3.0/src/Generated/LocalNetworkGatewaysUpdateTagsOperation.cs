...
namespace Azure.Management.Network
{
    ...
    public partial class LocalNetworkGatewaysUpdateTagsOperation : Operation<LocalNetworkGateway>, IOperationSource<LocalNetworkGateway>
    {
        private readonly ArmOperationHelpers<LocalNetworkGateway> _operation;
        internal LocalNetworkGatewaysUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<LocalNetworkGateway>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LocalNetworkGatewaysUpdateTagsOperation");
        }
        /// <inheritdoc />
