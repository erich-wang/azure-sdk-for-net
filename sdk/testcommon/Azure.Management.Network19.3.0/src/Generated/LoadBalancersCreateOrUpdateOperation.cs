...
namespace Azure.Management.Network
{
    ...
    public partial class LoadBalancersCreateOrUpdateOperation : Operation<LoadBalancer>, IOperationSource<LoadBalancer>
    {
        ...
        {
            _operation = new ArmOperationHelpers<LoadBalancer>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LoadBalancersCreateOrUpdateOperation");
        }
        /// <inheritdoc />
