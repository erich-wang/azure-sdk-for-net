...
namespace Azure.Management.Network
{
    ...
    public partial class NetworkSecurityGroupsCreateOrUpdateOperation : Operation<NetworkSecurityGroup>, IOperationSource<NetworkSecurityGroup>
    {
        ...
        {
            _operation = new ArmOperationHelpers<NetworkSecurityGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkSecurityGroupsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
