...
namespace Azure.Management.Network
{
    ...
    public partial class ExpressRouteCircuitsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<ExpressRouteCircuitsUpdateTagsOperation> StartUpdateTagsAsync(string resourceGroupName, string circuitName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitsClient.StartUpdateTags");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.UpdateTagsAsync(resourceGroupName, circuitName, parameters, cancellationToken).ConfigureAwait(false);
                return new ExpressRouteCircuitsUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, circuitName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> Parameters supplied to update express route circuit tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ExpressRouteCircuitsUpdateTagsOperation StartUpdateTags(string resourceGroupName, string circuitName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.UpdateTags(resourceGroupName, circuitName, parameters, cancellationToken);
                return new ExpressRouteCircuitsUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, circuitName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
