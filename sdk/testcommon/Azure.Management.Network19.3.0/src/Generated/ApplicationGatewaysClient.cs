...
namespace Azure.Management.Network
{
    ...
    public partial class ApplicationGatewaysClient
    {
        ...
        public ApplicationGatewaysClient(string subscriptionId, TokenCredential tokenCredential, NetworkManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of ApplicationGatewaysClient. </summary>
        public ApplicationGatewaysClient(string subscriptionId, string host, TokenCredential tokenCredential, NetworkManagementClientOptions options = null)
        {
            options ??= new NetworkManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new ApplicationGatewaysRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        public virtual async ValueTask<ApplicationGatewaysDeleteOperation> StartDeleteAsync(string resourceGroupName, string applicationGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewaysClient.StartDelete");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<ApplicationGatewaysUpdateTagsOperation> StartUpdateTagsAsync(string resourceGroupName, string applicationGatewayName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewaysClient.StartUpdateTags");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.UpdateTagsAsync(resourceGroupName, applicationGatewayName, parameters, cancellationToken).ConfigureAwait(false);
                return new ApplicationGatewaysUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, applicationGatewayName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> Parameters supplied to update application gateway tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ApplicationGatewaysUpdateTagsOperation StartUpdateTags(string resourceGroupName, string applicationGatewayName, TagsObject parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.UpdateTags(resourceGroupName, applicationGatewayName, parameters, cancellationToken);
                return new ApplicationGatewaysUpdateTagsOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateTagsRequest(resourceGroupName, applicationGatewayName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
        ...
        public virtual async ValueTask<ApplicationGatewaysStartOperation> StartStartAsync(string resourceGroupName, string applicationGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewaysClient.StartStart");
            scope.Start();
            try
            {
        ...
        public virtual async ValueTask<ApplicationGatewaysStopOperation> StartStopAsync(string resourceGroupName, string applicationGatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewaysClient.StartStop");
            scope.Start();
            try
            {
        ...
        public virtual async ValueTask<ApplicationGatewaysBackendHealthOperation> StartBackendHealthAsync(string resourceGroupName, string applicationGatewayName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewaysClient.StartBackendHealth");
            scope.Start();
            try
            {
