...
namespace Azure.Management.Network
{
    ...
    public partial class ExpressRouteCircuitsUpdateTagsOperation : Operation<ExpressRouteCircuit>, IOperationSource<ExpressRouteCircuit>
    {
        private readonly ArmOperationHelpers<ExpressRouteCircuit> _operation;
        internal ExpressRouteCircuitsUpdateTagsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ExpressRouteCircuit>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ExpressRouteCircuitsUpdateTagsOperation");
        }
        /// <inheritdoc />
