...
namespace Azure.Management.Resource
{
    ...
    public partial class ResourcesClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<ResourcesMoveResourcesOperation> StartMoveResourcesAsync(string sourceResourceGroupName, IEnumerable<string> resources = null, string targetResourceGroup = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new ResourcesMoveResourcesOperation(_clientDiagnostics, _pipeline, RestClient.CreateMoveResourcesRequest(sourceResourceGroupName, resources, targetResourceGroup).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="targetResourceGroup"> The target resource group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ResourcesMoveResourcesOperation StartMoveResources(string sourceResourceGroupName, IEnumerable<string> resources = null, string targetResourceGroup = null, CancellationToken cancellationToken = default)
        {
            if (sourceResourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(sourceResourceGroupName));
        ...
        /// <param name="targetResourceGroup"> The target resource group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<ResourcesValidateMoveResourcesOperation> StartValidateMoveResourcesAsync(string sourceResourceGroupName, IEnumerable<string> resources = null, string targetResourceGroup = null, CancellationToken cancellationToken = default)
        {
            if (sourceResourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(sourceResourceGroupName));
            ...
            try
            {
                ...
                return new ResourcesValidateMoveResourcesOperation(_clientDiagnostics, _pipeline, RestClient.CreateValidateMoveResourcesRequest(sourceResourceGroupName, resources, targetResourceGroup).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="targetResourceGroup"> The target resource group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ResourcesValidateMoveResourcesOperation StartValidateMoveResources(string sourceResourceGroupName, IEnumerable<string> resources = null, string targetResourceGroup = null, CancellationToken cancellationToken = default)
        {
            if (sourceResourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(sourceResourceGroupName));
