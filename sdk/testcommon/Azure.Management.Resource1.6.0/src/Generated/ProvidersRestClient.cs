...
namespace Azure.Management.Resource
{
    internal partial class ProvidersRestClient
    {
        ...
        public ProvidersRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2017-05-10")
        {
