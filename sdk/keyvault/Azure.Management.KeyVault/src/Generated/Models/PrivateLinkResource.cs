...
namespace Azure.Management.KeyVault.Models
{
    ...
    public partial class PrivateLinkResource : Resource
    {
        ...
        internal PrivateLinkResource(string groupId, IList<string> requiredMembers, IList<string> requiredZoneNames, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
            GroupId = groupId;
