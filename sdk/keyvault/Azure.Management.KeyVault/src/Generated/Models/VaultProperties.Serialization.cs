...
namespace Azure.Management.KeyVault.Models
{
    public partial class VaultProperties : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (SoftDeleteRetentionInDays != null)
            {
        ...
        internal static VaultProperties DeserializeVaultProperties(JsonElement element)
        {
            ...
            return new VaultProperties(tenantId, sku, accessPolicies, vaultUri, enabledForDeployment, enabledForDiskEncryption, enabledForTemplateDeployment, enableSoftDelete, softDeleteRetentionInDays, enableRbacAuthorization, createMode, enablePurgeProtection, networkAcls, privateEndpointConnections);
        }
    }
}
