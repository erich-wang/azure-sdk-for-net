...
namespace Azure.Management.KeyVault.Models
{
    ...
    public partial class PrivateEndpointConnection : Resource
    {
        ...
        internal PrivateEndpointConnection(PrivateEndpoint privateEndpoint, PrivateLinkServiceConnectionState privateLinkServiceConnectionState, PrivateEndpointConnectionProvisioningState? provisioningState, string id, string name, string type, string location, IDictionary<string, string> tags) : base(id, name, type, location, tags)
        {
