...
namespace Azure.Management.KeyVault
{
    public partial class VaultsClient
    {
        ...
        public virtual async Task<Response<Vault>> UpdateAsync(string resourceGroupName, string vaultName, IDictionary<string, string> tags, VaultPatchProperties properties, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="properties"> Properties of the vault. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Vault> Update(string resourceGroupName, string vaultName, IDictionary<string, string> tags, VaultPatchProperties properties, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<Vault> ListByResourceGroupAsync(string resourceGroupName, int? top, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="top"> Maximum number of results to return. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<Vault> ListByResourceGroup(string resourceGroupName, int? top, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="top"> Maximum number of results to return. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<Vault> ListBySubscriptionAsync(int? top, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="top"> Maximum number of results to return. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<Vault> ListBySubscription(int? top, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="top"> Maximum number of results to return. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AsyncPageable<Resource> ListAsync(int? top, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="top"> Maximum number of results to return. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<Resource> List(int? top, CancellationToken cancellationToken = default)
        {
        ...
        internal Operation<Vault> CreateCreateOrUpdate(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Put, "VaultsClient.CreateOrUpdate", OperationFinalStateVia.Location, createOriginalHttpMessage,
        ...
        internal Operation<Response> CreatePurgeDeleted(Response originalResponse, Func<HttpMessage> createOriginalHttpMessage)
        {
            ...
            return ArmOperationHelpers.Create(pipeline, clientDiagnostics, originalResponse, RequestMethod.Post, "VaultsClient.PurgeDeleted", OperationFinalStateVia.Location, createOriginalHttpMessage);
        }
