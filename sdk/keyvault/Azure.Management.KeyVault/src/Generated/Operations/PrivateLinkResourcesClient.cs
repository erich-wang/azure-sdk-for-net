...
namespace Azure.Management.KeyVault
{
    public partial class PrivateLinkResourcesClient
    {
        ...
        internal PrivateLinkResourcesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2019-09-01")
        {
