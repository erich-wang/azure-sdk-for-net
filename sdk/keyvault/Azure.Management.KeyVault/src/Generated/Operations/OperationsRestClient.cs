...
namespace Azure.Management.KeyVault
{
    internal partial class OperationsRestClient
    {
        ...
        public OperationsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "https://management.azure.com", string apiVersion = "2019-09-01")
        {
            if (host == null)
            {
