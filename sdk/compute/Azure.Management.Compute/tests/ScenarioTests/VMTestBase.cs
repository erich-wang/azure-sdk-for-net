...
using CM = Azure.Management.Compute.Models;
...
namespace Azure.Management.Compute.Tests
{
    public class VMTestBase : ComputeClientBase
    {
        ...
        protected DiskEncryptionSettings GetEncryptionSettings(bool addKek = false)
        {
            ...
            {
                DiskEncryptionKey = new KeyVaultSecretReference(encryptionKeyFakeUri, new Azure.Management.Compute.Models.SubResource(testVaultId))
            };

            if (addKek)
            {
                string nonExistentKekUri = @"https://testvault123.vault.azure.net/keys/TestKey/514ceb769c984379a7e0230bdd703272";
                diskEncryptionSettings.KeyEncryptionKey = new KeyVaultKeyReference(nonExistentKekUri, new Azure.Management.Compute.Models.SubResource(testVaultId));
            }
        ...
        protected async Task<string> CreateAvailabilitySet(string rgName, string asName, bool hasManagedDisks = false, string ppgId = null)
        {
            ...
            if (ppgId != null)
            {
                inputAvailabilitySet.ProximityPlacementGroup = new Azure.Management.Compute.Models.SubResource() { Id = ppgId };
            }
            ...
            string diskEncryptionSetId = null)
        {
            ...
            //    AvailabilitySet = new Azure.Management.Compute.Models.SubResource() { Id = asetId },
            ...
            //typeof( Azure.Management.Compute.Models.Resource).GetProperty("Name").SetValue(vm, Recording.GenerateAssetName("vm"));
            //typeof( Azure.Management.Compute.Models.Resource).GetProperty("Type").SetValue(vm, Recording.GenerateAssetName("Microsoft.Compute/virtualMachines"));
            return vm;
        }
        ...
        protected void ValidatePlan(Azure.Management.Compute.Models.Plan inputPlan, Azure.Management.Compute.Models.Plan outPutPlan)
        {
            if (inputPlan == null
                 || outPutPlan == null
               )
