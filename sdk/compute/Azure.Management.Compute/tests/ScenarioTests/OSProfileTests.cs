...
#pragma warning disable 1998
            ...
            public static async Task<Azure.Management.Compute.Models.SubResource> GetVaultId(string subId, string rgName, string keyVaultName)
            {
                return new Azure.Management.Compute.Models.SubResource { Id = KeyVaultId };
            }
