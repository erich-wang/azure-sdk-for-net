...
namespace Azure.Management.Compute
{
    ...
    public partial class ProximityPlacementGroupsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ProximityPlacementGroup>> UpdateAsync(string resourceGroupName, string proximityPlacementGroupName, IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProximityPlacementGroupsClient.Update");
            scope.Start();
            try
            {
                return await RestClient.UpdateAsync(resourceGroupName, proximityPlacementGroupName, tags, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ProximityPlacementGroup> Update(string resourceGroupName, string proximityPlacementGroupName, IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProximityPlacementGroupsClient.Update");
            scope.Start();
            try
            {
                return RestClient.Update(resourceGroupName, proximityPlacementGroupName, tags, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
