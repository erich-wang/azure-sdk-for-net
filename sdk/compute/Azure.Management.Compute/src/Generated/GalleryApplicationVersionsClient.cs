...
namespace Azure.Management.Compute
{
    ...
    public partial class GalleryApplicationVersionsClient
    {
        ...
        public GalleryApplicationVersionsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of GalleryApplicationVersionsClient. </summary>
        public GalleryApplicationVersionsClient(string subscriptionId, string host, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new GalleryApplicationVersionsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        public virtual async ValueTask<GalleryApplicationVersionsUpdateOperation> StartUpdateAsync(string resourceGroupName, string galleryName, string galleryApplicationName, string galleryApplicationVersionName, IDictionary<string, string> tags = null, GalleryApplicationVersionPublishingProfile publishingProfile = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var originalResponse = await RestClient.UpdateAsync(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, tags, publishingProfile, cancellationToken).ConfigureAwait(false);
                return new GalleryApplicationVersionsUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, tags, publishingProfile).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="publishingProfile"> The publishing profile of a gallery Image Version. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual GalleryApplicationVersionsUpdateOperation StartUpdate(string resourceGroupName, string galleryName, string galleryApplicationName, string galleryApplicationVersionName, IDictionary<string, string> tags = null, GalleryApplicationVersionPublishingProfile publishingProfile = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.Update(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, tags, publishingProfile, cancellationToken);
                return new GalleryApplicationVersionsUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, tags, publishingProfile).Request, originalResponse);
            }
            catch (Exception e)
            {
