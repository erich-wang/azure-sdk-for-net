...
namespace Azure.Management.Compute
{
    ...
    public partial class DisksClient
    {
        ...
        public DisksClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of DisksClient. </summary>
        public DisksClient(string subscriptionId, string host, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new DisksRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<DisksGrantAccessOperation> StartGrantAccessAsync(string resourceGroupName, string diskName, AccessLevel access, int durationInSeconds, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = await RestClient.GrantAccessAsync(resourceGroupName, diskName, access, durationInSeconds, cancellationToken).ConfigureAwait(false);
                return new DisksGrantAccessOperation(_clientDiagnostics, _pipeline, RestClient.CreateGrantAccessRequest(resourceGroupName, diskName, access, durationInSeconds).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="durationInSeconds"> Time duration in seconds until the SAS access expires. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DisksGrantAccessOperation StartGrantAccess(string resourceGroupName, string diskName, AccessLevel access, int durationInSeconds, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.GrantAccess(resourceGroupName, diskName, access, durationInSeconds, cancellationToken);
                return new DisksGrantAccessOperation(_clientDiagnostics, _pipeline, RestClient.CreateGrantAccessRequest(resourceGroupName, diskName, access, durationInSeconds).Request, originalResponse);
            }
            catch (Exception e)
            {
