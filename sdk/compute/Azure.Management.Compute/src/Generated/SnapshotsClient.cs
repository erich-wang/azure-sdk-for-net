...
namespace Azure.Management.Compute
{
    ...
    public partial class SnapshotsClient
    {
        ...
        internal SnapshotsRestClient RestClient { get; }
        /// <summary> Initializes a new instance of SnapshotsClient for mocking. </summary>
        protected SnapshotsClient()
        {
        }

        /// <summary> Initializes a new instance of SnapshotsClient. </summary>
        public SnapshotsClient(string subscriptionId, TokenCredential tokenCredential, ComputeManagementClientOptions options = null) : this(subscriptionId, "https://management.azure.com", tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of SnapshotsClient. </summary>
        public SnapshotsClient(string subscriptionId, string host, TokenCredential tokenCredential, ComputeManagementClientOptions options = null)
        {
            options ??= new ComputeManagementClientOptions();
            _clientDiagnostics = new ClientDiagnostics(options);
            _pipeline = ManagementPipelineBuilder.Build(tokenCredential, host, options);
            RestClient = new SnapshotsRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, host: host);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Snapshot> ListByResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.ListByResourceGroup");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<Snapshot> ListAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<Snapshot>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.List");
                scope.Start();
                try
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<SnapshotsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string snapshotName, Snapshot snapshot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<SnapshotsUpdateOperation> StartUpdateAsync(string resourceGroupName, string snapshotName, SnapshotUpdate snapshot, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.StartUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="snapshotName"> The name of the snapshot that is being created. The name can&apos;t be changed after the snapshot is created. Supported characters for the name are a-z, A-Z, 0-9 and _. The max name length is 80 characters. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<SnapshotsDeleteOperation> StartDeleteAsync(string resourceGroupName, string snapshotName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.StartDelete");
            scope.Start();
            try
            {
        ...
        /// <param name="resourceGroupName"> The name of the resource group. </param>
        /// <param name="snapshotName"> The name of the snapshot that is being created. The name can&apos;t be changed after the snapshot is created. Supported characters for the name are a-z, A-Z, 0-9 and _. The max name length is 80 characters. </param>
        /// <param name="access"> The AccessLevel to use. </param>
        /// <param name="durationInSeconds"> Time duration in seconds until the SAS access expires. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<SnapshotsGrantAccessOperation> StartGrantAccessAsync(string resourceGroupName, string snapshotName, AccessLevel access, int durationInSeconds, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.StartGrantAccess");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.GrantAccessAsync(resourceGroupName, snapshotName, access, durationInSeconds, cancellationToken).ConfigureAwait(false);
                return new SnapshotsGrantAccessOperation(_clientDiagnostics, _pipeline, RestClient.CreateGrantAccessRequest(resourceGroupName, snapshotName, access, durationInSeconds).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="durationInSeconds"> Time duration in seconds until the SAS access expires. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual SnapshotsGrantAccessOperation StartGrantAccess(string resourceGroupName, string snapshotName, AccessLevel access, int durationInSeconds, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.GrantAccess(resourceGroupName, snapshotName, access, durationInSeconds, cancellationToken);
                return new SnapshotsGrantAccessOperation(_clientDiagnostics, _pipeline, RestClient.CreateGrantAccessRequest(resourceGroupName, snapshotName, access, durationInSeconds).Request, originalResponse);
            }
            catch (Exception e)
            {
        ...
        /// <param name="snapshotName"> The name of the snapshot that is being created. The name can&apos;t be changed after the snapshot is created. Supported characters for the name are a-z, A-Z, 0-9 and _. The max name length is 80 characters. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<SnapshotsRevokeAccessOperation> StartRevokeAccessAsync(string resourceGroupName, string snapshotName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("SnapshotsClient.StartRevokeAccess");
            scope.Start();
            try
            {
