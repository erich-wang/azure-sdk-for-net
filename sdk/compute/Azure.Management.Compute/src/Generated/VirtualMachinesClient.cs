...
namespace Azure.Management.Compute
{
    ...
    public partial class VirtualMachinesClient
    {
        ...
        internal VirtualMachinesRestClient RestClient { get; }
        /// <summary> Initializes a new instance of VirtualMachinesClient for mocking. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.InstanceView");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.Generalize");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.SimulateEviction");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<VirtualMachine> ListByLocationAsync(string location, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.ListByLocation");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<VirtualMachine> ListAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<VirtualMachine>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.List");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<VirtualMachine> ListAllAsync(string statusOnly = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<VirtualMachine>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.ListAll");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<VirtualMachineSize> ListAvailableSizesAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.ListAvailableSizes");
                scope.Start();
                try
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesCaptureOperation> StartCaptureAsync(string resourceGroupName, string vmName, VirtualMachineCaptureParameters parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartCapture");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string vmName, VirtualMachine parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesUpdateOperation> StartUpdateAsync(string resourceGroupName, string vmName, VirtualMachineUpdate parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesDeleteOperation> StartDeleteAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartDelete");
            scope.Start();
            try
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesConvertToManagedDisksOperation> StartConvertToManagedDisksAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartConvertToManagedDisks");
            scope.Start();
            try
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesDeallocateOperation> StartDeallocateAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartDeallocate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesPowerOffOperation> StartPowerOffAsync(string resourceGroupName, string vmName, bool? skipShutdown = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartPowerOff");
            scope.Start();
            try
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesReapplyOperation> StartReapplyAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartReapply");
            scope.Start();
            try
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesRestartOperation> StartRestartAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartRestart");
            scope.Start();
            try
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesStartOperation> StartStartAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartStart");
            scope.Start();
            try
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesRedeployOperation> StartRedeployAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartRedeploy");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesReimageOperation> StartReimageAsync(string resourceGroupName, string vmName, bool? tempDisk = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartReimage");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.ReimageAsync(resourceGroupName, vmName, tempDisk, cancellationToken).ConfigureAwait(false);
                return new VirtualMachinesReimageOperation(_clientDiagnostics, _pipeline, RestClient.CreateReimageRequest(resourceGroupName, vmName, tempDisk).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="tempDisk"> Specifies whether to reimage temp disk. Default value: false. Note: This temp disk reimage parameter is only supported for VM/VMSS with Ephemeral OS disk. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual VirtualMachinesReimageOperation StartReimage(string resourceGroupName, string vmName, bool? tempDisk = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.Reimage(resourceGroupName, vmName, tempDisk, cancellationToken);
                return new VirtualMachinesReimageOperation(_clientDiagnostics, _pipeline, RestClient.CreateReimageRequest(resourceGroupName, vmName, tempDisk).Request, originalResponse);
            }
            catch (Exception e)
            {
        ...
        /// <param name="vmName"> The name of the virtual machine. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesPerformMaintenanceOperation> StartPerformMaintenanceAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartPerformMaintenance");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<VirtualMachinesRunCommandOperation> StartRunCommandAsync(string resourceGroupName, string vmName, RunCommandInput parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartRunCommand");
            scope.Start();
            try
            {
