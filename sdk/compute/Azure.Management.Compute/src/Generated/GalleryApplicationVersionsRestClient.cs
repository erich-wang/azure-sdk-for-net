...
namespace Azure.Management.Compute
{
    internal partial class GalleryApplicationVersionsRestClient
    {
        ...
        public GalleryApplicationVersionsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
        ...
        internal HttpMessage CreateUpdateRequest(string resourceGroupName, string galleryName, string galleryApplicationName, string galleryApplicationVersionName, IDictionary<string, string> tags, GalleryApplicationVersionPublishingProfile publishingProfile)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            request.Uri = uri;
            request.Headers.Add("Content-Type", "application/json");
            var model = new GalleryApplicationVersionUpdate()
            {
                Tags = tags,
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response> UpdateAsync(string resourceGroupName, string galleryName, string galleryApplicationName, string galleryApplicationVersionName, IDictionary<string, string> tags = null, GalleryApplicationVersionPublishingProfile publishingProfile = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateUpdateRequest(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, tags, publishingProfile);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="publishingProfile"> The publishing profile of a gallery Image Version. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response Update(string resourceGroupName, string galleryName, string galleryApplicationName, string galleryApplicationVersionName, IDictionary<string, string> tags = null, GalleryApplicationVersionPublishingProfile publishingProfile = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
