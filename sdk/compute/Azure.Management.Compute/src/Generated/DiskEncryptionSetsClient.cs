...
namespace Azure.Management.Compute
{
    ...
    public partial class DiskEncryptionSetsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async ValueTask<DiskEncryptionSetsUpdateOperation> StartUpdateAsync(string resourceGroupName, string diskEncryptionSetName, IDictionary<string, string> tags = null, KeyVaultAndKeyReference activeKey = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = await RestClient.UpdateAsync(resourceGroupName, diskEncryptionSetName, tags, activeKey, cancellationToken).ConfigureAwait(false);
                return new DiskEncryptionSetsUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, diskEncryptionSetName, tags, activeKey).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="activeKey"> Key Vault Key Url and vault id of KeK, KeK is optional and when provided is used to unwrap the encryptionKey. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DiskEncryptionSetsUpdateOperation StartUpdate(string resourceGroupName, string diskEncryptionSetName, IDictionary<string, string> tags = null, KeyVaultAndKeyReference activeKey = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.Update(resourceGroupName, diskEncryptionSetName, tags, activeKey, cancellationToken);
                return new DiskEncryptionSetsUpdateOperation(_clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(resourceGroupName, diskEncryptionSetName, tags, activeKey).Request, originalResponse);
            }
            catch (Exception e)
            {
