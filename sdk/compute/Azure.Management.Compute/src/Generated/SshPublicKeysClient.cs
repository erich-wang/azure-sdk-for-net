...
namespace Azure.Management.Compute
{
    ...
    public partial class SshPublicKeysClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<SshPublicKeyResource>> UpdateAsync(string resourceGroupName, string sshPublicKeyName, IDictionary<string, string> tags = null, string publicKey = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SshPublicKeysClient.Update");
            scope.Start();
            try
            {
                return await RestClient.UpdateAsync(resourceGroupName, sshPublicKeyName, tags, publicKey, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="publicKey"> SSH public key used to authenticate to a virtual machine through ssh. If this property is not initially provided when the resource is created, the publicKey property will be populated when generateKeyPair is called. If the public key is provided upon resource creation, the provided public key needs to be at least 2048-bit and in ssh-rsa format. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SshPublicKeyResource> Update(string resourceGroupName, string sshPublicKeyName, IDictionary<string, string> tags = null, string publicKey = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SshPublicKeysClient.Update");
            scope.Start();
            try
            {
                return RestClient.Update(resourceGroupName, sshPublicKeyName, tags, publicKey, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
