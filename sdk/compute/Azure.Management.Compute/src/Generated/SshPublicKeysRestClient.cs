...
{
    internal partial class SshPublicKeysRestClient
    {
        ...
        /// <summary> Initializes a new instance of SshPublicKeysRestClient. </summary>
        public SshPublicKeysRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com")
        {
        ...
        internal HttpMessage CreateUpdateRequest(string resourceGroupName, string sshPublicKeyName, IDictionary<string, string> tags, string publicKey)
        {
            ...
            request.Uri = uri;
            request.Headers.Add("Content-Type", "application/json");
            var model = new SshPublicKeyUpdateResource(tags, publicKey);
            using var content = new Utf8JsonRequestContent();
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<SshPublicKeyResource>> UpdateAsync(string resourceGroupName, string sshPublicKeyName, IDictionary<string, string> tags = null, string publicKey = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="publicKey"> SSH public key used to authenticate to a virtual machine through ssh. If this property is not initially provided when the resource is created, the publicKey property will be populated when generateKeyPair is called. If the public key is provided upon resource creation, the provided public key needs to be at least 2048-bit and in ssh-rsa format. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<SshPublicKeyResource> Update(string resourceGroupName, string sshPublicKeyName, IDictionary<string, string> tags = null, string publicKey = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
